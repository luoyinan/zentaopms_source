...
class helper extends baseHelper
{
     ...
     * @return array[]
     */
    public static function parseSqlToSemantic($sql)
    {
        $sql = trim($sql);
        if($sql === '') return [];
     ...
     */
    private static function extractTableName($full)
    {
     ...
     * @return string[]
     */
    private static function splitAlterClauses($body)
    {
        $clauses    = [];
        $current    = '';
        $len        = strlen($body);
 ...
 * @return bool
 */
function checkFlowActionCondition($actionConfig, $action, $item, $model)
{
    global $app;
