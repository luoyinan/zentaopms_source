...
class baseHelper
{
     ...
     * @return string
     */
    public static function quoteWindowsPath($path)
    {
     ...
     * @return string
     */
    public static function buildGrantPermissionCommand($path, $recursive = false, $mode = '777', $linuxPrefix = '', $isDir = true)
    {
        if(static::isWindows())
        {
     ...
     * @return string
     */
    public static function buildMkdirCommand($path, $linuxPrefix = '')
    {
     ...
     * @return string
     */
    public static function buildDeleteCommand($path, $isDir, $linuxPrefix = '')
    {
        if(static::isWindows())
        {
            $path = static::quoteWindowsPath($path);
     ...
     * @return string
     */
    public static function writeCommandScript($script, $commands)
    {
