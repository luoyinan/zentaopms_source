...
class api extends router
{
     ...
     * @return bool
     */
    protected function hasSearchFilters()
    {
     ...
     * @return void
     */
    protected function sendV2Error($message)
    {
     ...
     * @return array
     */
    protected function getOriginRouteSearch()
    {
     ...
     * @return string
     */
    protected function resolveSearchModule($routeSearch)
    {
     ...
     * @return string
     */
    protected function resolveQuerySessionKey($routeSearch)
    {
     ...
     * @return array
     */
    protected function prepareRealRouteSearchContext($routeSearch)
    {
        $searchModule    = $this->resolveSearchModule($routeSearch);
     ...
     * @return array
     */
    protected function buildPreparedSearchConfig($searchModule, $querySessionKey, $configModule = null)
    {
     ...
     * @return array
     */
    protected function normalizeSearchFilters($filters, $searchFields)
    {
     ...
     * @return array
     */
    protected function buildSearchFormPayload($filters, $querySessionKey)
    {
        $groupItems = max(1, (int)zget($this->config->search, 'groupItems', 3));
     ...
     * @return void
     */
    protected function prepareV2Search()
    {
     ...
     * @return array
     */
    protected function parseWorkflowNamespaceRoute($pathItems)
    {
     ...
     * @return void
     */
    protected function handleWorkflowNamespaceRoute($pathItems)
    {
     ...
     * @return void
     */
    protected function prepareDeleteConfirmParam()
    {
     ...
     * @return void
     */
    protected function prepareRedirectParams()
    {
     ...
     * @return void
     */
    protected function validateRequiredParams($defaultParams, $sourceParams)
    {
     ...
     * @return array
     */
    protected function normalizeGetParams($defaultParams, $sourceParams)
    {
        $params = array();
        foreach($defaultParams as $key => $defaultItem)
        {
     ...
     * @return array
     */
    protected function parseRouteData($data, $paramValues)
    {
        foreach($paramValues as $key => $value)
        {
            if(is_numeric($key)) continue;
     ...
     * @return void
     */
    protected function mergeRouteParamsToPost()
    {
     ...
     * @return void
     */
    protected function normalizeBatchPostData()
    {
     ...
     * @return array
     */
    protected function transposeBatchPostRows($rows)
    {
        $fieldNames = array();
        foreach($rows as $row)
        {
     ...
     * @return array|null
     */
    protected function getCurrentFormConfig()
    {
     ...
     * @return void
     */
    protected function normalizeRouteParamsAfterPostMerge()
    {
        $defaultParams = $this->resolveDefaultParams();
        foreach($defaultParams as $key => $defaultItem)
        {
