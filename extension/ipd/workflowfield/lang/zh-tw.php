...
$lang->workflowfield->approval->fields['reviewedBy']    = '已審批人';
...
$lang->workflowfield->tips->emptySubStatus     = '%s的子狀態的選項值不能為空。';
$lang->workflowfield->tips->emptyValue         = '您沒有選擇任何欄位，無法啟用顯示值設置功能，請至少選擇一個欄位或者關閉顯示值設置功能。';
$lang->workflowfield->tips->emptyExport        = '您沒有為表 <TABLE> 選擇任何欄位，該表無法啟用導出功能，請至少選擇一個欄位或者關閉導出功能。';
$lang->workflowfield->tips->emptySearch        = '您沒有選擇任何欄位，無法啟用搜索功能，請至少選擇一個欄位或者關閉搜索功能。';
...
$lang->workflowfield->error->remainFields     = '%s 為系統保留關鍵字，請更改欄位代號。';
$lang->workflowfield->error->emptyOptions     = '請輸入選項的鍵和值。';
$lang->workflowfield->error->wrongCode        = '%s 只能包含英文字母。';
$lang->workflowfield->error->longCode         = '%s 長度不能超過30。';
$lang->workflowfield->error->wrongSQL         = 'SQL語句有錯！錯誤：';
$lang->workflowfield->error->notunique        = '必須添加唯一驗證';
$lang->workflowfield->error->defaultValue     = '預設值 的長度不應該超過%s。';
$lang->workflowfield->error->textDefaultValue = 'text類型欄位不能設置預設值';
$lang->workflowfield->error->duplicatedCode   = '鍵名 %s 重複，請修改。';
$lang->workflowfield->error->duplicatedName   = '值 %s 重複，請修改。';
$lang->workflowfield->error->emptyDefault     = '請選擇一個預設值。';
$lang->workflowfield->error->emptyCustomField = '您還沒有添加欄位，會影響您的正常使用，請先添加欄位。';
$lang->workflowfield->error->length           = '%s應該大於等於%s，且小於等於%s。';
$lang->workflowfield->error->digits           = '%s應該大於等於%s。';
$lang->workflowfield->error->dateFormat       = '日期 格式錯誤，必須為Y-m-d。';
$lang->workflowfield->error->timeFormat       = '時間 格式錯誤，必須為Y-m-d H:i。';
$lang->workflowfield->error->intSize          = '預設值 應該大於等於%s，且小於等於%s。';
$lang->workflowfield->error->float            = '預設值 應該為數字，可以是小數。';
$lang->workflowfield->error->existDelay       = '%s 已在系統中使用，請更改欄位代號。';
...
$lang->workflowfield->excel->tips       = "1、欄位名稱和代號為必填項，代號只能包含英文字母。\r\n2、“選項”的輸入格式為“鍵,值”，鍵/值之間用英文逗號分隔，多組鍵/值之間用換行分隔。";
