...
$lang->workflow->onlyCustom     = '仅自定义流程';
...
$lang->workflow->tips->release               = '该工作流发布后，项目流程中的通用流程会同步修改。';
$lang->workflow->tips->activate              = '工作流启用后，项目流程中的通用流程和自定义流程是否也要一起启用？';
$lang->workflow->tips->deactivate            = '您确定要停用此工作流吗？';
$lang->workflow->tips->syncDeactivate        = '该工作流停用后，项目流程中不能使用该工作流对象。';
$lang->workflow->tips->belongDisabled        = '该工作流已在项目流程中设置了自定义流程，不能修改从属对象。';
...
$lang->workflow->tips->belongError           = '该工作流已在%s项目流程下设置了自定义流程，无法切换所属视图。';
...
$lang->workflow->error->emptyType       = '类型字段不能为空。';
$lang->workflow->error->wrongType       = '类型字段值只能是 flow 或 table。';
