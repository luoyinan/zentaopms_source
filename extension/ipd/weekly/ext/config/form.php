...
$config->weekly->form->create['reportModule'] = array('type' => 'string', 'required' => true,  'default' => '');
...
$config->weekly->form->ajaxsetbasic['reportModule'] = array('type' => 'string', 'required' => true, 'default' => '');
