...
$lang->project->deliverableProject     = "所屬{$lang->projectCommon}";
...
$lang->project->checkDeliverableTips  = '請將該交付物評審通過或進行確認。';
...
$lang->project->autoSchedule   = '自動排期';
$lang->project->preBegin       = '原計劃開始';
$lang->project->preEnd         = '原計劃完成';
$lang->project->preLeftDays    = '原剩餘可用工作日';
$lang->project->leftDays       = '剩餘可用工作日';
$lang->project->schedule       = "{$lang->projectCommon}工期日曆";
$lang->project->workingHours   = '每日工作';
$lang->project->executionGantt = "{$lang->execution->common}甘特圖";

$lang->project->outSideDays = '工期外天數，共%s天';
$lang->project->workingDays = "共%s天的{$lang->projectCommon}工期工作日。";
$lang->project->setWorking  = "重新設為{$lang->projectCommon}工期日";
...
$lang->project->WorkHoursError = '每日工作最大時長需要大於等於最小時長。';

$lang->project->taskSchedule     = '任務排期列';
$lang->project->taskAutoSchedule = '任務自動排期';

$lang->project->globalScheduleSuccess         = '全局排期成功';
$lang->project->manualScheduleSuccess         = '局部排期成功';
$lang->project->globalScheduleConfirmText     = '啟用全局排期，將導致以下任務%s排期發生變化：';
$lang->project->manualScheduleConfirmText     = '%s的計划起止日期調整，將導致以下%s排期發生變化：';
$lang->project->scheduleBlankText             = '';
$lang->project->scheduleTaskText              = '任務';
$lang->project->scheduleExecutionText         = '執行';
$lang->project->scheduleConfirmTitle          = '排期調整確認';
$lang->project->scheduleConfirmTaskText       = '...等%s個任務';
$lang->project->scheduleConfirmExecutionText  = '...等%s個執行';
$lang->project->scheduleConfirmResult         = '是否保存本次排期結果？';

$lang->project->scheduleEndConflict           = "排期後任務的計劃截止%s超出{$lang->projectCommon}計劃完成%s，請調整任務工期或{$lang->projectCommon}工期。";
$lang->project->scheduleStageConflictTitle    = '排期受限';
$lang->project->scheduleStageConflictText     = '任務計划起止日期超出了串列階段計划起止日期範圍，系統無法進行排期';
$lang->project->scheduleStageFrozen           = '項目計劃已打基線。排期後，任務計划起止日期超出執行計劃的時間範圍。請在項目變更申請審批通過後，重新進行排期操作。';
$lang->project->scheduleDataEmpty             = '暫時沒有任務，無法使用自動排期。';

$lang->project->taskScheduleList = array();
$lang->project->taskScheduleList['normal']    = '正常';
$lang->project->taskScheduleList['exception'] = '異常';
