...
$lang->project->deliverableProject     = "所属{$lang->projectCommon}";
...
$lang->project->checkDeliverableTips  = '请将该交付物评审通过或进行确认。';
...
$lang->project->autoSchedule   = '自动排期';
$lang->project->preBegin       = '原计划开始';
$lang->project->preEnd         = '原计划完成';
$lang->project->preLeftDays    = '原剩余可用工作日';
$lang->project->leftDays       = '剩余可用工作日';
$lang->project->schedule       = "{$lang->projectCommon}工期日历";
$lang->project->workingHours   = '每日工作';
$lang->project->executionGantt = "{$lang->execution->common}甘特图";

$lang->project->outSideDays = '工期外天数，共%s天';
$lang->project->workingDays = "共%s天的{$lang->projectCommon}工期工作日。";
$lang->project->setWorking  = "重新设为{$lang->projectCommon}工期日";

$lang->project->workDaysList = array();
$lang->project->workDaysList[1] = '周六上班';
$lang->project->workDaysList[2] = '周日上班';

$lang->project->weeks     = array('1' => '一', '2' => '二', '3' => '三', '4' => '四', '5' => '五', '6' => '六', '0' => '日');
$lang->project->fullWeeks = array('1' => '周一', '2' => '周二', '3' => '周三', '4' => '周四', '5' => '周五', '6' => '周六', '0' => '周日');

$lang->project->WorkHoursError = '每日工作最大时长需要大于等于最小时长。';

$lang->project->taskSchedule     = '任务排期列';
$lang->project->taskAutoSchedule = '任务自动排期';

$lang->project->globalScheduleSuccess         = '全局排期成功';
$lang->project->manualScheduleSuccess         = '局部排期成功';
$lang->project->globalScheduleConfirmText     = '启用全局排期，将导致以下任务%s排期发生变化：';
$lang->project->manualScheduleConfirmText     = '%s的计划起止日期调整，将导致以下%s排期发生变化：';
$lang->project->scheduleBlankText             = '';
$lang->project->scheduleTaskText              = '任务';
$lang->project->scheduleExecutionText         = '执行';
$lang->project->scheduleConfirmTitle          = '排期调整确认';
$lang->project->scheduleConfirmTaskText       = '...等%s个任务';
$lang->project->scheduleConfirmExecutionText  = '...等%s个执行';
$lang->project->scheduleConfirmResult         = '是否保存本次排期结果？';

$lang->project->scheduleEndConflict           = "排期后任务的计划截止%s超出{$lang->projectCommon}计划完成%s，请调整任务工期或{$lang->projectCommon}工期。";
$lang->project->scheduleStageConflictTitle    = '排期受限';
$lang->project->scheduleStageConflictText     = '任务计划起止日期超出了串行阶段计划起止日期范围，系统无法进行排期';
$lang->project->scheduleStageFrozen           = '项目计划已打基线。排期后，任务计划起止日期超出执行计划的时间范围。请在项目变更申请审批通过后，重新进行排期操作。';
$lang->project->scheduleDataEmpty             = '暂时没有任务，无法使用自动排期。';

$lang->project->taskScheduleList = array();
$lang->project->taskScheduleList['normal']    = '正常';
$lang->project->taskScheduleList['exception'] = '异常';
