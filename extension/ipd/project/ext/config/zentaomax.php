...
if(helper::hasFeature('deliverable'))
{
    ...
    if(!isset($config->project->groupPrivs)) $config->project->groupPrivs = array();
    $config->project->groupPrivs['closuredeliverable'] = 'deliverable';
}
...
$config->project->deliverable->dtable->fieldList['status']['width']     = '140';
$config->project->deliverable->dtable->fieldList['status']['align']     = 'left';
...
if(helper::hasFeature('project_process'))
{
    $config->project->deliverable->dtable->fieldList['activity']['title']    = $lang->deliverable->activity;
    $config->project->deliverable->dtable->fieldList['activity']['name']     = 'activity';
    $config->project->deliverable->dtable->fieldList['activity']['type']     = 'category';
    $config->project->deliverable->dtable->fieldList['activity']['sortType'] = true;
}

$config->project->deliverable->dtable->fieldList['stage']['title']    = $lang->deliverable->when;
$config->project->deliverable->dtable->fieldList['stage']['name']     = 'stage';
$config->project->deliverable->dtable->fieldList['stage']['type']     = 'category';
$config->project->deliverable->dtable->fieldList['stage']['sortType'] = false;
$config->project->deliverable->dtable->fieldList['stage']['width']    = '120';

$config->project->deliverable->dtable->fieldList['required']['title']    = $lang->deliverable->required;
$config->project->deliverable->dtable->fieldList['required']['name']     = 'required';
$config->project->deliverable->dtable->fieldList['required']['type']     = 'category';
$config->project->deliverable->dtable->fieldList['required']['sortType'] = false;
$config->project->deliverable->dtable->fieldList['required']['width']    = '100';
$config->project->deliverable->dtable->fieldList['required']['map']      = $lang->deliverable->requiredList;

$config->project->deliverable->dtable->fieldList['submittedBy']['title']    = $lang->project->submitedBy;
$config->project->deliverable->dtable->fieldList['submittedBy']['name']     = 'submittedBy';
$config->project->deliverable->dtable->fieldList['submittedBy']['type']     = 'user';
$config->project->deliverable->dtable->fieldList['submittedBy']['sortType'] = true;
$config->project->deliverable->dtable->fieldList['submittedBy']['show']     = true;
$config->project->deliverable->dtable->fieldList['submittedBy']['width']    = '120';

$config->project->deliverable->dtable->fieldList['submittedDate']['title']    = $lang->project->submitedDate;
$config->project->deliverable->dtable->fieldList['submittedDate']['name']     = 'submittedDate';
$config->project->deliverable->dtable->fieldList['submittedDate']['type']     = 'datetime';
$config->project->deliverable->dtable->fieldList['submittedDate']['show']     = true;
$config->project->deliverable->dtable->fieldList['submittedDate']['sortType'] = true;
$config->project->deliverable->dtable->fieldList['submittedDate']['width']    = '120';
...
$config->project->deliverable->dtable->fieldList['actions']['menu']     = array('submitReview|recallDeliverable', 'reviewDeliverable', 'editDeliverable', 'deleteDeliverable');
...
$config->project->deliverablechecklist->dtable->fieldList['deliverableID']['link']     = array('module' => 'project', 'method' => 'viewDeliverable', 'params' => 'id={deliverableID}', 'target' => '_blank');
...
$config->project->deliverablechecklist->dtable->fieldList['submittedBy']['title']    = $lang->project->submitedBy;
$config->project->deliverablechecklist->dtable->fieldList['submittedBy']['name']     = 'submittedBy';
$config->project->deliverablechecklist->dtable->fieldList['submittedBy']['type']     = 'user';
$config->project->deliverablechecklist->dtable->fieldList['submittedBy']['sortType'] = false;
$config->project->deliverablechecklist->dtable->fieldList['submittedBy']['show']     = true;
if($isEn) $config->project->deliverablechecklist->dtable->fieldList['submittedBy']['width'] = '120';

$config->project->deliverablechecklist->dtable->fieldList['submittedDate']['title']    = $lang->project->submitedDate;
$config->project->deliverablechecklist->dtable->fieldList['submittedDate']['name']     = 'submittedDate';
$config->project->deliverablechecklist->dtable->fieldList['submittedDate']['type']     = 'datetime';
$config->project->deliverablechecklist->dtable->fieldList['submittedDate']['sortType'] = false;
$config->project->deliverablechecklist->dtable->fieldList['submittedDate']['show']     = true;
if($isEn) $config->project->deliverablechecklist->dtable->fieldList['submittedDate']['width'] = '120';
...
if(helper::hasFeature('project_process')) $config->project->deliverableSearch['fields']['activity'] = $lang->deliverable->activity;
...
$config->project->deliverableSearch['fields']['submittedBy']   = $lang->project->submitedBy;
$config->project->deliverableSearch['fields']['submittedDate'] = $lang->project->submitedDate;
...
if(helper::hasFeature('project_process')) $config->project->deliverableSearch['params']['activity'] = array('operator' => '=', 'control' => 'select', 'values' => '');
...
$config->project->deliverableSearch['params']['submittedBy']   = array('operator' => '=', 'control' => 'select', 'values' => 'users');
$config->project->deliverableSearch['params']['submittedDate'] = array('operator' => '=', 'control' => 'date', 'values' => '');
...
$config->project->actions->viewdeliverable['mainActions']   = array('submitReview', 'recallDeliverable', 'reviewDeliverable');
...
$config->project->form->create['schedule'] = array('type' => 'string', 'required' => false, 'default' => '', 'control' => 'editor');
$config->project->form->edit['schedule']   = array('type' => 'string', 'required' => false, 'default' => '', 'control' => 'editor');

$config->project->form->batchedit['schedule'] = array('type' => 'string', 'required' => false, 'default' => '', 'control' => 'editor');

$config->project->execution->dtable->fieldList['actions']['actionsMap']['gantt']['icon'] = 'gantt';
$config->project->execution->dtable->fieldList['actions']['actionsMap']['gantt']['hint'] = $lang->project->executionGantt;
$config->project->execution->dtable->fieldList['actions']['actionsMap']['gantt']['url']  = helper::createLink('execution', 'gantt', 'executionID={rawID}');

array_unshift($config->project->execution->dtable->actionsRule['scrum'], 'gantt');
array_unshift($config->project->execution->dtable->actionsRule['kanban'], 'gantt');
array_unshift($config->project->execution->dtable->actionsRule['agileplus'], 'gantt');
array_unshift($config->project->execution->dtable->actionsRule['waterfall'], 'gantt');
array_unshift($config->project->execution->dtable->actionsRule['waterfallplus'], 'gantt');
if($config->edition == 'ipd') array_unshift($config->project->execution->dtable->actionsRule['ipd'], 'gantt');

$config->project->includedPriv['execution'][] = 'createGanttVersion';
$config->project->includedPriv['execution'][] = 'editGanttVersion';
$config->project->includedPriv['execution'][] = 'deleteGanttVersion';
$config->project->includedPriv['execution'][] = 'diffGanttVersion';
if($config->vision == 'rnd') $config->project->includedPriv['execution'][] = 'taskAutoSchedule';
