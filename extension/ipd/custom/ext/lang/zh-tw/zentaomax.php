...
$lang->custom->projectchange->fields['urgencyList'] = '變更等級';
$lang->custom->projectchange->fields['typeList']    = '變更類型';

$lang->custom->projectFeatures['issue']         = '問題';
$lang->custom->projectFeatures['risk']          = '風險';
$lang->custom->projectFeatures['opportunity']   = '機會';
$lang->custom->projectFeatures['process']       = '過程';
$lang->custom->projectFeatures['auditplan']     = 'QA';
$lang->custom->projectFeatures['meeting']       = '會議';
$lang->custom->projectFeatures['deliverable']   = '交付物';
$lang->custom->projectFeatures['review']        = '評審';
$lang->custom->projectFeatures['cm']            = '基線';
$lang->custom->projectFeatures['change']        = '變更';
$lang->custom->projectFeatures['measrecord']    = '度量';
$lang->custom->projectFeatures['gapanalysis']   = '培訓';
$lang->custom->projectFeatures['researchplan']  = '調研';

$lang->custom->bug->fields['injectionList'] = '注入環節';
$lang->custom->bug->fields['identifyList']  = '發現環節';

$lang->custom->reviewissue = new stdClass();
$lang->custom->reviewissue->fields['resolutionList'] = '解決方案';
