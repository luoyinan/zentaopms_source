...
$config->ticket->dtable->fieldList['product']['dataSource'] = array('module' => 'feedback', 'method' =>'getGrantProducts', 'params' => array('isPairs' => true, 'isDefault' => false, 'params' => 'all'));
...
$config->ticket->dtable->fieldList['assignedTo']['assignLink'] = array('module' => 'ticket', 'method' => 'assignTo', 'params' => 'ticketID={id}');
