...
$config->reviewissue->form->resolved['resolution']     = array('required' => true,  'type' => 'string',   'default' => '');
$config->reviewissue->form->resolved['resolutionDate'] = array('required' => false, 'type' => 'datetime', 'default' => helper::now());
$config->reviewissue->form->resolved['assignedTo']     = array('required' => false, 'type' => 'string',   'default' => '');
$config->reviewissue->form->resolved['comment']        = array('required' => false, 'type' => 'string',   'default' => '', 'control' => 'editor');
