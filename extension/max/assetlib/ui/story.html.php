...
if($browseType == 'draft')
{
    $config->assetlib->dtable->story->fieldList['assignedTo']['type']       = 'assign';
    $config->assetlib->dtable->story->fieldList['assignedTo']['assignLink'] = array('module' => 'assetlib', 'method' => 'assignToStory', 'params' => 'storyID={id}');
}
