...
$lang->admin->menuList->feature['tabMenu']['project']['reviewissue'] = array('link' => "Review Issue|custom|set|module=reviewissue&fieldList=resolutionList", 'exclude' => 'custom');

$lang->admin->menuList->feature['tabMenu']['measure']['measurement']  = array('link' => 'Interval Reminder|measurement|settips|');
