...
$lang->admin->menuList->feature['tabMenu']['project']['reviewissue'] = array('link' => "评审问题|custom|set|module=reviewissue&fieldList=resolutionList", 'exclude' => 'custom');

$lang->admin->menuList->feature['tabMenu']['measure']['measurement']  = array('link' => '区间提示|measurement|settips|');
