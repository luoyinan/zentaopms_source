...
$lang->admin->menuList->feature['tabMenu']['project']['reviewissue'] = array('link' => "評審問題|custom|set|module=reviewissue&fieldList=resolutionList", 'exclude' => 'custom');

$lang->admin->menuList->feature['tabMenu']['measure']['measurement']  = array('link' => '區間提示|measurement|settips|');
