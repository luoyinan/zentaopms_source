...
$config->feedback->products = new stdclass();
$config->feedback->products->actionList = array();
$config->feedback->products->actionList['manageProduct']['icon']        = 'private';
$config->feedback->products->actionList['manageProduct']['text']        = $lang->feedback->manageProduct;
$config->feedback->products->actionList['manageProduct']['hint']        = $lang->feedback->manageProduct;
$config->feedback->products->actionList['manageProduct']['url']         = array('module' => 'feedback', 'method' => 'manageProduct', 'params' => 'product={id}');
$config->feedback->products->actionList['manageProduct']['data-toggle'] = 'modal';

$config->feedback->dtable->products = new stdclass();
$config->feedback->dtable->products->fieldList['name']['title']        = $lang->productCommon;
$config->feedback->dtable->products->fieldList['name']['name']         = 'name';
$config->feedback->dtable->products->fieldList['name']['nestedToggle'] = true;
$config->feedback->dtable->products->fieldList['name']['type']         = 'title';
$config->feedback->dtable->products->fieldList['name']['group']        = '1';

$config->feedback->dtable->products->fieldList['authorizedUser']['title'] = $lang->user->common;
$config->feedback->dtable->products->fieldList['authorizedUser']['name']  = 'authorizedUser';
$config->feedback->dtable->products->fieldList['authorizedUser']['type']  = 'desc';
$config->feedback->dtable->products->fieldList['authorizedUser']['group'] = '2';

$config->feedback->dtable->products->fieldList['actions']['name']  = 'actions';
$config->feedback->dtable->products->fieldList['actions']['title'] = $lang->actions;
$config->feedback->dtable->products->fieldList['actions']['type']  = 'actions';
$config->feedback->dtable->products->fieldList['actions']['list']  = $config->feedback->products->actionList;
$config->feedback->dtable->products->fieldList['actions']['menu']  = array('manageProduct');
