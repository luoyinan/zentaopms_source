...
$config->custom->canAdd['reviewissue']   = 'resolutionList';
...
$config->custom->relateObjectList['projectdeliverable'] = $lang->deliverable->common;
...
$config->custom->relateObjectFields['projectdeliverable'] = array('id', 'relation', 'title', 'name', 'project', 'version', 'versionStatus', 'isBaseline', 'status', 'submittedBy', 'submittedDate');
