    ...
    <?php if(empty($faqs)):?>
      ...
      <div class="table-empty-tip">
        <p>
          ...
          <?php echo html::a($this->createLink('faq', 'create', "productID=$currentProduct&moduleID=$currentModule"), "<i class='icon icon-plus'></i> " . $lang->faq->create, '', "class='btn btn-info'");?>
          <?php endif;?>
        </p>
      </div>
      <?php endif;?>
      ...
      <div class="panel-body">
        ...
        <table class='table table-form'>
          ...
          <tr>
            ...
            <span class='actions'>
            <?php if(common::hasPriv('faq', 'edit'))   echo html::a($this->createLink('faq', 'edit', "faqID=$faq->id"), $lang->edit)?>
