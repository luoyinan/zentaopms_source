...
$lang->workflow->onlyCustom     = 'Only Custom Flow';

$lang->workflow->setFulltextSearch = 'Full-Text Retrieval';
$lang->workflow->browseAction      = 'Flow List';
$lang->workflow->releaseAction     = 'Release Flow';
$lang->workflow->deactivateAction  = 'Disable Flow';
$lang->workflow->activateAction    = 'Enable Flow';
$lang->workflow->setJSAction       = 'JS Settings';
$lang->workflow->setCSSAction      = 'CSS Settings';

$lang->workflow->id            = 'ID';
$lang->workflow->parent        = 'Prev';
$lang->workflow->type          = 'Type';
$lang->workflow->app           = 'App';
$lang->workflow->navigator     = 'Navigator';
...
$lang->workflow->navigators['primary']   = 'Primary';
...
$lang->workflow->notOverride                 = 'The extension method is not override, please modify <a href="%s" data-toggle="modal" data-width="600">extension method</a>';
...
$lang->workflow->error->emptyType       = 'The type field is required.';
$lang->workflow->error->wrongType       = 'The type field should be flow or table.';
...
if($config->db->driver == 'dm') unset($lang->workfloweditor->moreSettings['relation']);