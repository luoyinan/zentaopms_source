...
(
    ...
    (
        ...
        !empty($config->openedApproval) && $config->edition != 'biz' && $flow->type == 'flow' && $flow->approval == 'enabled' ? item(set::name($lang->workflowapproval->approvalFlow), zget($approvalFlows, $approvalFlow)) : null,
