...
$lang->workflowaction->default->actions['copy']           = 'Copy';
...
$lang->workflowaction->error->wrongCode   = '%s should be letters.';
$lang->workflowaction->error->builtinCode = "Couldn't use the built-in action code %s.";
$lang->workflowaction->error->conflict    = '%s conflicts with system language.';
...
$lang->workflowaction->actionWidth = 140;

$lang->workflowaction->browseAction = 'Action List';
$lang->workflowaction->setJSAction  = 'Set JS';
$lang->workflowaction->setCSSAction = 'Set CSS';

$lang->workflowaction->upgrade = array();
$lang->workflowaction->upgrade['biz7.4']['feedback']['reply']    = 'Reply';
$lang->workflowaction->upgrade['biz7.4']['feedback']['ask']      = 'Ask';
$lang->workflowaction->upgrade['biz7.4']['bug']['batchactivate'] = 'Batch Activate';
