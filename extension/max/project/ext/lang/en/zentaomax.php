...
$lang->project->deliverableProject     = $lang->projectCommon;
...
$lang->project->checkDeliverableTips  = 'Please approve the deliverable through review or confirm it.';
...
$lang->project->submitted          = 'Submitted';
...
$lang->project->autoSchedule   = 'Auto Schedule';
$lang->project->preBegin       = 'Original Plan Begin';
$lang->project->preEnd         = 'Original Plan End';
$lang->project->preLeftDays    = 'Original Left Days';
$lang->project->leftDays       = 'Left Days';
$lang->project->schedule       = "{$lang->projectCommon} Schedule";
$lang->project->workingHours   = 'Working';
$lang->project->executionGantt = "{$lang->execution->common} Gantt";

$lang->project->outSideDays = 'Outside days total of %s';
$lang->project->workingDays = "A total of %s working days for the {$lang->projectCommon} duration.";
$lang->project->setWorking  = 'Reset to working day';

$lang->project->workDaysList = array();
$lang->project->workDaysList[1] = 'Working on SAT';
$lang->project->workDaysList[2] = 'Working on SUN';

$lang->project->weeks     = array('0' => 'SUN', '1' => 'MON', '2' => 'TUE', '3' => 'WED', '4' => 'THU', '5' => 'FRI', '6' => 'SAT');
$lang->project->fullWeeks = array('0' => 'SUN', '1' => 'MON', '2' => 'TUE', '3' => 'WED', '4' => 'THU', '5' => 'FRI', '6' => 'SAT');

$lang->project->WorkHoursError = 'The maximum daily working hours need to be greater than or equal to the minimum working hours.';

$lang->project->taskSchedule     = 'Task Schedule';
$lang->project->taskAutoSchedule = 'Task Auto Schedule';

$lang->project->globalScheduleSuccess         = 'Global Schedule Success';
$lang->project->manualScheduleSuccess         = 'Local Schedule Success';
$lang->project->globalScheduleConfirmText     = 'Enabling global scheduling will result in changes to the scheduling of the following tasks %s:';
$lang->project->manualScheduleConfirmText     = 'Adjusting the planned dates for %s will change the following %s schedules:';
$lang->project->scheduleBlankText             = ' ';
$lang->project->scheduleTaskText              = 'Task';
$lang->project->scheduleExecutionText         = 'Execution';
$lang->project->scheduleConfirmTitle          = 'Schedule adjustment confirm';
$lang->project->scheduleConfirmTaskText       = '...etc, %s tasks';
$lang->project->scheduleConfirmExecutionText  = '...etc, %s executions';
$lang->project->scheduleConfirmResult         = 'Would you like to save the current scheduling result?';

$lang->project->scheduleEndConflict           = "Scheduled task deadline %s exceeds {$lang->projectCommon} end date %s. Please adjust the task or {$lang->projectCommon} duration.";
$lang->project->scheduleStageConflictTitle    = 'Scheduling limited';
$lang->project->scheduleStageConflictText     = "Task dates fall outside the serial phase's planned range; scheduling failed";
$lang->project->scheduleStageFrozen           = 'The project has been baselined. Scheduled dates are outside the execution. Please reschedule after the Change Request is approved';
$lang->project->scheduleDataEmpty             = 'No tasks available. Auto-scheduling is disabled.';

$lang->project->taskScheduleList = array();
$lang->project->taskScheduleList['normal']    = 'Normal';
$lang->project->taskScheduleList['exception'] = 'Exception';
