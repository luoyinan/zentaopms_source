...
$config->execution->form->create['schedule']    = array('type' => 'string', 'required' => false, 'control' => 'editor', 'default' => '');
$config->execution->form->edit['schedule']      = array('type' => 'string', 'required' => false, 'control' => 'editor', 'default' => '');

$config->execution->form->batchedit['id']       = array('type' => 'int',    'required' => false, 'base' => true);
$config->execution->form->batchedit['schedule'] = array('type' => 'string', 'required' => false, 'control' => 'editor', 'default' => '');

$config->execution->form->autoSchedule = array();
$config->execution->form->autoSchedule['id']       = array('type' => 'int',    'required' => false, 'base' => true);
$config->execution->form->autoSchedule['begin']    = array('type' => 'date',   'required' => true);
$config->execution->form->autoSchedule['end']      = array('type' => 'date',   'required' => true);
$config->execution->form->autoSchedule['schedule'] = array('type' => 'string', 'required' => false, 'control' => 'editor');
