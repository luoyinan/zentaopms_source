...
$config->workflowlabel->approval->params['reviewedby'][0]['field']    = 'deleted';
$config->workflowlabel->approval->params['reviewedby'][0]['operator'] = 'equal';
$config->workflowlabel->approval->params['reviewedby'][0]['value']    = '0';
$config->workflowlabel->approval->params['reviewedby'][1]['field']    = 'reviewedBy';
$config->workflowlabel->approval->params['reviewedby'][1]['operator'] = 'include';
$config->workflowlabel->approval->params['reviewedby'][1]['value']    = 'currentUser';