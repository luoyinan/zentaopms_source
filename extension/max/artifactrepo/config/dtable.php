...
$config->artifactrepo->dtable->fieldList['space']['title'] = $lang->artifactrepo->space;
$config->artifactrepo->dtable->fieldList['space']['name']  = 'space';
$config->artifactrepo->dtable->fieldList['space']['width'] = '300';
$config->artifactrepo->dtable->fieldList['space']['hint']  = true;
