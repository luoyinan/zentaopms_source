...
$lang->workflowfield->browseAction   = 'Fields List';
...
$lang->workflowfield->approval->fields['reviewedBy']    = 'Reviewed By';
...
$lang->workflowfield->tips->emptyValue         = 'No fields selected and can not enable the display value function.';
$lang->workflowfield->tips->emptyExport        = 'No fields selected for the table <strong>TABLE</strong> and can not enable the search function.';
$lang->workflowfield->tips->emptySearch        = 'No fields selected and can not enable the search function.';
...
$lang->workflowfield->error->existDelay       = '%s has been used in the system, please change the field code.';
...
$lang->workflowfield->excel->tips       = "1. Name and Field is required. The Field should be letters. 2. The Options should be in 'key,value' format, separated by comma, multiple groups separated by a newline.";
