...
foreach($report['issue'] as $issue)
{
    ...
    (
        ...
        h::td(set::colspan('2'), zget($lang->reviewissue->statusList, $issue->status))
    );
}
...
(
    ...
    (
        ...
        (
            ...
            h::tr
            (
                h::th(setClass('text-left'), $lang->cm->projectID, set::colspan('2')),
                h::td(setClass('text-left'), set::colspan('6'), $report['project']->id),
                h::th(setClass('text-left'), set::colspan('2'),$lang->cm->release),
                h::td(setClass('text-left'), set::colspan('2'), zget($lang->project->modelList, $report['project']->model)),
            ),
            h::tr
            (
                h::th(setClass('text-left'), $lang->cm->projectName, set::colspan('2')),
                h::td(setClass('text-left'), set::colspan('6'), $report['project']->name),
                h::th(setClass('text-left'), $lang->cm->compiling, set::colspan('2')),
                h::td(setClass('text-left'), set::colspan('2'), zget($users, $report['project']->PM))
            ),
            h::tr
            (
            ...
            (
                setClass('text-center'),
                h::td(setClass('text-center'), set::colspan('12'), h5($lang->cm->issueList))
            ),
            h::tr
            (
