...
if(isset($cols['name'])) $cols['name']['link'] = array('module' => $flow->module, 'method' => 'view', 'params' => 'id={id}'); // name字段加链接。
...
(
    ...
    $summary ? set::checkInfo(jsRaw('window.setStatistics')) : null,
    $summary ? set::footer(array(array('html' => $summary), 'flex', 'pager')) : null,
    set::orderBy($orderBy),
