...
$items[$lang->projectchange->status]    = zget($lang->projectchange->statusList, $projectchange->status, '') . ($projectchange->isConditionalPassApproval ? '(' . $lang->review->resultList['conditional'] . ')' : '');
