...
$config->group->package->deployPlan->privs['deploy-browse']   = array('edition' => 'biz,max,ipd', 'vision' => 'rnd', 'order' => 5,  'depend' => array(),                'recommend' => array('deploy-activate', 'deploy-create', 'deploy-edit', 'deploy-finish', 'deploy-view'));
$config->group->package->deployPlan->privs['deploy-view']     = array('edition' => 'biz,max,ipd', 'vision' => 'rnd', 'order' => 10, 'depend' => array('deploy-browse'), 'recommend' => array('deploy-activate', 'deploy-create', 'deploy-edit', 'deploy-finish'));
$config->group->package->deployPlan->privs['deploy-steps']    = array('edition' => 'biz,max,ipd', 'vision' => 'rnd', 'order' => 15, 'depend' => array('deploy-browse', 'deploy-view'),  'recommend' => array('deploy-assignTo', 'deploy-manageStep', 'deploy-viewStep'));
$config->group->package->deployPlan->privs['deploy-viewStep'] = array('edition' => 'biz,max,ipd', 'vision' => 'rnd', 'order' => 20, 'depend' => array('deploy-browse', 'deploy-steps'), 'recommend' => array('deploy-assignTo', 'deploy-finishStep', 'deploy-manageStep'));
$config->group->package->deployPlan->privs['deploy-cases']    = array('edition' => 'biz,max,ipd', 'vision' => 'rnd', 'order' => 25, 'depend' => array('deploy-browse'), 'recommend' => array('deploy-linkCases', 'deploy-unlinkCase'));
...
$config->group->package->completeDeployStep->order  = 25;
...
$config->group->package->completedDeploy->order  = 30;
