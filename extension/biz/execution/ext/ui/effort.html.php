...
$toolbarItems = array();
if(hasPriv('effort', 'export')) $toolbarItems[] = array('type' => 'ghost', 'text' => $lang->effort->export, 'icon' => 'import', 'url' => createLink('effort', 'export', "userID=$userID&orderBy=date_asc&date=&executionID=$executionID"), 'data-toggle' => 'modal');
