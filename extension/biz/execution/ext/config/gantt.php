<?php
$config->execution->custom->customGanttFields = 'id,branch,ownerID,status,progress,begin,realBegan,deadline,realEnd,duration,estimate,consumed,left,delay,delayDays,taskType,openedBy,openedDate,assignedDate,finishedBy,closedBy,closedDate,closedReason,lastEditedBy,lastEditedDate,activatedDate,story,keywords,mailto';

$config->execution->ganttCustom = new stdclass();
$config->execution->ganttCustom->ganttFields = 'ownerID,progress,begin,deadline,duration';
