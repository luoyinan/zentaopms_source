...
$lang->workflowfield->approval->fields['reviewedBy']    = '已审批人';
...
$lang->workflowfield->tips->emptySubStatus     = '%s的子状态的选项值不能为空。';
$lang->workflowfield->tips->emptyValue         = '您没有选择任何字段，无法启用显示值设置功能，请至少选择一个字段或者关闭显示值设置功能。';
$lang->workflowfield->tips->emptyExport        = '您没有为表 <TABLE> 选择任何字段，该表无法启用导出功能，请至少选择一个字段或者关闭导出功能。';
$lang->workflowfield->tips->emptySearch        = '您没有选择任何字段，无法启用搜索功能，请至少选择一个字段或者关闭搜索功能。';
...
$lang->workflowfield->error->remainFields     = '%s 为系统保留关键字，请更改字段代号。';
$lang->workflowfield->error->emptyOptions     = '请输入选项的键和值。';
$lang->workflowfield->error->wrongCode        = '%s 只能包含英文字母。';
$lang->workflowfield->error->longCode         = '%s 长度不能超过30。';
$lang->workflowfield->error->wrongSQL         = 'SQL语句有错！错误：';
$lang->workflowfield->error->notunique        = '必须添加唯一验证';
$lang->workflowfield->error->defaultValue     = '默认值 的长度不应该超过%s。';
$lang->workflowfield->error->textDefaultValue = 'text类型字段不能设置默认值';
$lang->workflowfield->error->duplicatedCode   = '键名 %s 重复，请修改。';
$lang->workflowfield->error->duplicatedName   = '值 %s 重复，请修改。';
$lang->workflowfield->error->emptyDefault     = '请选择一个默认值。';
$lang->workflowfield->error->emptyCustomField = '您还没有添加字段，会影响您的正常使用，请先添加字段。';
$lang->workflowfield->error->length           = '%s应该大于等于%s，且小于等于%s。';
$lang->workflowfield->error->digits           = '%s应该大于等于%s。';
$lang->workflowfield->error->dateFormat       = '日期 格式错误，必须为Y-m-d。';
$lang->workflowfield->error->timeFormat       = '时间 格式错误，必须为Y-m-d H:i。';
$lang->workflowfield->error->intSize          = '默认值 应该大于等于%s，且小于等于%s。';
$lang->workflowfield->error->float            = '默认值 应该为数字，可以是小数。';
$lang->workflowfield->error->existDelay       = '%s 已在系统中使用，请更改字段代号。';
...
$lang->workflowfield->excel->tips       = "1、字段名称和代号为必填项，代号只能包含英文字母。\r\n2、“选项”的输入格式为“键,值”，键/值之间用英文逗号分隔，多组键/值之间用换行分隔。";
...
$lang->workflowfield->upgrade['biz10.2']['feedback']['pri']            = '优先级';
$lang->workflowfield->upgrade['biz10.2']['feedback']['activatedBy']    = '由谁激活';
$lang->workflowfield->upgrade['biz10.2']['feedback']['activatedDate']  = '激活时间';
$lang->workflowfield->upgrade['biz10.2']['feedback']['repeatFeedback'] = '重复反馈';
$lang->workflowfield->upgrade['biz10.2']['feedback']['keywords']       = '关键词';