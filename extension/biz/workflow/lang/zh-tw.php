...
$lang->workflow->onlyCustom     = '僅自定義流程';
...
$lang->workflow->tips->release               = '該工作流發佈後，項目流程中的通用流程會同步修改。';
$lang->workflow->tips->activate              = '工作流啟用後，項目流程中的通用流程和自定義流程是否也要一起啟用？';
$lang->workflow->tips->deactivate            = '您確定要停用此工作流嗎？';
$lang->workflow->tips->syncDeactivate        = '該工作流停用後，項目流程中不能使用該工作流對象。';
$lang->workflow->tips->belongDisabled        = '該工作流已在項目流程中設置了自定義流程，不能修改從屬對象。';
...
$lang->workflow->tips->belongError           = '該工作流已在%s項目流程下設置了自定義流程，無法切換所屬視圖。';
...
$lang->workflow->error->emptyType       = '類型欄位不能為空。';
$lang->workflow->error->wrongType       = '類型欄位值只能是 flow 或 table。';
