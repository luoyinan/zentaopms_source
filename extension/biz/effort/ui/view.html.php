...
(
    ...
    (
        ...
        item(set::name($lang->effort->objectType), zget($lang->effort->objectTypeList, $effort->objectType, ''), $work ? a(set::href($this->createLink($effort->objectType == 'case' ? 'testcase' : $effort->objectType, 'view', "objectID={$effort->objectID}")), set(array('data-toggle' => 'modal', 'data-size' => 'lg')), ' #' . $effort->objectID . ' ' . $work[$effort->objectID]) : ''),
