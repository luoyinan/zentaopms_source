...
(
    ...
    (
        ...
        (
            ...
            empty($roadmaps) && in_array($story->stage, array('wait', 'inroadmap', 'incharter')) ? btn(set::url(createLink('roadmap', 'create', "productID={$story->product}")), setData(array('toggle' => 'modal')), icon('plus')) : null,
