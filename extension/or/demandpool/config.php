...
$config->demandpool->actions = new stdclass();
$config->demandpool->actions->view = array();
$config->demandpool->actions->view['mainActions']   = array('close', 'activate');
$config->demandpool->actions->view['suffixActions'] = array('edit', 'delete');
