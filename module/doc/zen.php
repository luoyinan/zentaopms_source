...
class docZen extends doc
{
     ...
     * @return void
     */
    protected function responseAfterMove($space, $libID = 0, $docID = 0, $spaceTypeChanged = false, $docType = '', $actionType = 'move')
    {
     ...
     * @return bool|int
     */
    protected function responseAfterUploadDocs($docResult, $from = '')
    {
     ...
     * @return object
     */
    protected function initDocContext($docID, &$libID, &$spaceType, &$space)
    {
        if($spaceType == 'quick')
        {
            $libID = 0;
     ...
     * @return object
     */
    protected function prepareDocFormData($spaceType, $space)
    {
        return form::data()
     ...
     * @return void
     */
    protected function prepareDocViewData($spaceType, $space, &$libID, $docID, $doc)
    {
