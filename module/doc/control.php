...
class doc extends control
{
     ...
     * @return void
     */
    public function uploadDocs($docID, $objectType, $objectID, $libID, $moduleID = 0, $docType = '', $from = '')
    {
        $chapterID = 0;
        if(!empty($docID))
        {
    ...
    public function copyDoc($docID, $libID = 0, $spaceType = '', $space = '')
    {
        $doc = $this->docZen->initDocContext($docID, $libID, $spaceType, $space);
     ...
     * @return void
     */
    public function ajaxQuick($type = 'view', $pageID = 1, $recPerPage = 20, $search = '', $filterType = '')
    {
        if(!isset($this->config->doc->quickMenu[$type])) $type = 'view';
     ...
     * @return void
     */
    public function ajaxGetSpaceData($type = 'custom', $spaceID = 0, $picks = '')
    {
     ...
     * @return array
     */
    private function buildSpaceDataBase($type, $spaceID, $picks = '')
    {
        $noPicks = empty($picks);
        $picks   = $noPicks ? '' : ",$picks,";
     ...
     * @access public
     */
    public function setDocBasic($objectType, $objectID, $libID = 0, $moduleID = 0, $parentID = 0, $docID = 0, $isDraft = 'no', $modalType = 'doc', $docType = 'text')
    {
