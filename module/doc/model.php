...
class docModel extends model
{
     ...
     * @return array
     */
    public function getDocsWithPager($libs, $spaceType, $excludeID = 0, $queryTemplate = false, $filterType = '', $pager = null, $search = '', $searchType = 'all')
    {
        $searchCond = array();
        if(!empty($search))
        {
     ...
     * @return array
     */
    private function processDocList($docs, $rootDocs, $spaceType)
    {
     ...
     * @return array
     */
    private function buildDocQuery($libs, $queryTemplate, $excludeID, $filterType, $searchCond, $pager, $hasModule)
    {
     ...
     * @return array
     */
    public function getMineList($type, $browseType, $queryID = 0, $orderBy = 'id_desc', $pager = null, $appendDocs = '', $filterDocs = '', $filterType = '')
    {
        $query = '';
        if($browseType == 'bysearch')
        {
     ...
     * @return object
     */
    private function appendDocFilters($dao, $browseType, $queryString, $filterType, $hasPrivDocIdList, $filterDocs, $appendDocs, $orderBy)
    {
    ...
    public function getMySpaceDocs($type, $browseType, $query = '', $orderBy = 'id_desc', $pager = null, $appendDocs = '', $filterDocs = '', $filterType = '')
    {
     ...
     * @return bool
     */
    private function validateDocUrl($doc)
    {
     ...
     * @return int|false
     */
    public function copyDoc($docID, $targetData)
    {
     ...
     * @return bool
     */
    public function copyDocFiles($newDocID, $docType, $originalContent)
    {
     ...
     * @return void
     */
    protected function updateDocContent($newDocID, $docType, $gidMap)
    {
