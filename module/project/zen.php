...
class projectZen extends project
{
     ...
     * @return void
     */
    protected function prepareModuleForBug($productID, $projectID, $browseType, $param, $orderBy, $build, $branchID, $products)
    {
     ...
     * @return void
     */
    protected function processBugSearchParams($project, $browseType, $param, $projectID, $productID, $branchID, $orderBy, $build, $products)
    {
        $this->loadModel('bug');
     ...
     * @return void
     */
    protected function buildBugView($productID, $projectID, $project, $browseType, $param, $orderBy, $build, $branchID, $products, $recTotal, $recPerPage, $pageID)
    {
        $this->loadModel('bug');
        $this->loadModel('user');
