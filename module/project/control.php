...
class project extends control
{
     ...
     * @return void
     */
    public function execution($browseType = 'undone', $projectID = 0, $orderBy = 'order_asc', $productID = 0, $recTotal = 0, $recPerPage = 100, $pageID = 1, $queryID = 0)
    {
     ...
     * @return void
     */
    public function bug($projectID = 0, $productID = 0, $branchID = 'all', $orderBy = 'status,id_desc', $build = 0, $browseType = 'all', $param = 0, $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
        /* Load models. */
        $this->loadModel('product');
     ...
     * @return void
     */
    public function build($projectID = 0, $browseType = 'all', $param = 0, $orderBy = 't1.date_desc,t1.id_desc', $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
        /* Set menu lang. */
        $this->project->setMenu($projectID);
        $project = $this->project->getByID($projectID);
