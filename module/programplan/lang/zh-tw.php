 ...
 *
 * @copyright   Copyright 2009-2023 禪道軟件（青島）集團有限公司(ZenTao Software (Qingdao) Co., Ltd. www.cnezsoft.com)
...
$lang->programplan->ganttExport   = '甘特圖導出';
...
$lang->programplan->createVersion    = '創建版本';
$lang->programplan->editVersion      = '編輯版本';
...
$lang->programplan->editGanttVersion    = '編輯版本';
$lang->programplan->deleteGanttVersion  = '刪除版本';
$lang->programplan->diffGanttVersion    = '版本對比';
...
$lang->programplan->noticeDiffVersion = '對比時，左側版本以正常顏色顯示，右側版本以深灰色顯示。';
...
$lang->programplan->ganttCustom['ownerID']        = '負責人';
$lang->programplan->ganttCustom['status']         = '狀態';
$lang->programplan->ganttCustom['begin']          = '計劃開始';
...
$lang->programplan->ganttCustom['taskProgress']   = '進度';
$lang->programplan->ganttCustom['estimate']       = '預計';
$lang->programplan->ganttCustom['consumed']       = '消耗';
$lang->programplan->ganttCustom['left']           = '剩餘';
$lang->programplan->ganttCustom['delay']          = '是否延期';
$lang->programplan->ganttCustom['delayDays']      = '延期天數';
$lang->programplan->ganttCustom['taskType']       = '類型';
$lang->programplan->ganttCustom['openedBy']       = '創建者';
$lang->programplan->ganttCustom['openedDate']     = '創建日期';
$lang->programplan->ganttCustom['assignedDate']   = '指派日期';
$lang->programplan->ganttCustom['finishedBy']     = '完成者';
$lang->programplan->ganttCustom['closedBy']       = '由誰關閉';
$lang->programplan->ganttCustom['closedDate']     = '關閉時間';
$lang->programplan->ganttCustom['closedReason']   = '關閉原因';
$lang->programplan->ganttCustom['canceledBy']     = '由誰取消';
$lang->programplan->ganttCustom['canceledDate']   = '取消時間';
$lang->programplan->ganttCustom['lastEditedBy']   = '最後修改';
$lang->programplan->ganttCustom['lastEditedDate'] = '最後修改日期';
$lang->programplan->ganttCustom['activatedDate']  = '激活日期';
$lang->programplan->ganttCustom['story']          = '研發需求';
$lang->programplan->ganttCustom['keywords']       = '關鍵詞';
$lang->programplan->ganttCustom['mailto']         = '抄送給';
...
$lang->programplan->ganttBrowseType['type']       = '按任務類型分組';
$lang->programplan->ganttBrowseType['module']     = '按模組分組';
$lang->programplan->ganttBrowseType['story']      = "按{$lang->SRCommon}分組";
$lang->programplan->ganttBrowseType['status']     = '按狀態分組';
$lang->programplan->ganttBrowseType['pri']        = '按優先順序分組';
$lang->programplan->ganttBrowseType['finishedBy'] = '按完成者分組';
$lang->programplan->ganttBrowseType['closedBy']   = '按關閉者分組';
