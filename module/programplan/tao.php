...
class programplanTao extends programplanModel
{
     ...
     * @return array
     */
    protected function buildTaskGroup($tasks, $type = 'assignedTo')
    {
        $taskGroup  = array();
        $multiTasks = array();
     ...
     * @return object
     */
    protected function buildGroupDataForGantt($groupID, $group, $type = 'assignedTo', $objects = array())
    {
        $this->app->loadLang('task');
        $groupName = $group;
     ...
     * @access public
     */
    public function sortForGantt($tasks, $orderBy)
    {
