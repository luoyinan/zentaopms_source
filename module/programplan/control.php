...
class programplan extends control
{
     ...
     * @return void
     */
    public function browse($projectID = 0, $productID = 0, $type = '', $orderBy = '', $baselineID = 0, $browseType = '', $queryID = 0, $from = 'project', $blockID = 0, $versionID = '0')
    {
     ...
     * @return void
     */
    public function createGanttVersion($projectID = 0, $productID = 0, $type = '')
    {
        if($_POST)
        {
            $project = $this->loadModel('project')->fetchByID($projectID);
     ...
     * @return void
     */
    public function editGanttVersion($versionID)
    {
        if($_POST)
        {
     ...
     * @return void
     */
    public function deleteGanttVersion($versionID)
    {
        $oldVersion = $this->programplan->fetchByID($versionID, 'ganttversion');
