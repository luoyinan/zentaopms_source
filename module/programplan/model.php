...
class programplanModel extends model
{
     ...
     * @return string|array
     */
    public function getDataForGantt($projectID, $productID, $baselineID = 0, $selectCustom = '', $returnJson = true, $browseType = '', $queryID = 0, $orderBy = '')
    {
     ...
     * @return string|array
     */
    public function getDataForGanttGroup($type, $executionID, $productID, $baselineID = 0, $selectCustom = '', $returnJson = true, $browseType = '', $queryID = 0, $orderBy = '')
    {
        $datas       = array();
        $stageIndex  = array();
     ...
     * @return array
     */
    public function getGanttTasks($projectID, $planIdList, $browseType, $queryID, $pager = null, $type = 'execution')
    {
        $tasks = array();
        if($browseType == 'bysearch')
        {
     ...
     * @return array
     */
    public function getGanttVersions($projectID, $productID = 0, $category = '', $type = 'project')
    {
     ...
     * @return array
     */
    public function getGanttDataByVersion($versionID)
    {
     ...
     * @return array
     */
    public function processNoWaitGanttData($tasks)
    {
        $pausedTasks = array();
