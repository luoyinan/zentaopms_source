...
禪道項目管理軟件由<strong><a href='https://easycorp.cn' target='_blank' class='text-danger'>禪道軟件（青島）集團有限公司</a></strong>開發。
...
$lang->install->groupList['DEVOPSADMIN']['name']     = 'DevOps管理員';
$lang->install->groupList['DEVOPSINSPECTOR']['name'] = 'DevOps巡視員';
$lang->install->groupList['DEVOPSUSER']['name']      = 'DevOps開發者';
...
$lang->install->dbProgressLabel = '進度';
$lang->install->dbExecutingTips = '請耐心等待，切勿刷新頁面、斷電、關機！';
$lang->install->dbFail          = "安裝資料庫表失敗。請檢查網絡請求是否暢通，資料庫配置是否正確，資料庫用戶是否有權限創建表，或者返回前頁選擇清空數據後重試。";
...
$lang->install->changeModes['delete'] = '刪除';

$lang->install->changeActions = [];
$lang->install->changeActions['createView']  = '創建資料庫視圖 %VIEW%';
$lang->install->changeActions['dropView']    = '刪除資料庫視圖 %VIEW%';
$lang->install->changeActions['createTable'] = '創建資料庫表 %TABLE%';
$lang->install->changeActions['dropTable']   = '刪除資料庫表 %TABLE%';
$lang->install->changeActions['renameTable'] = '修改資料庫表 %OLD% 的名稱為 %NEW%';
$lang->install->changeActions['addField']    = '給資料庫表 %TABLE% 添加 %FIELD% 欄位';
$lang->install->changeActions['modifyField'] = '修改資料庫表 %TABLE% 的 %FIELD% 欄位';
$lang->install->changeActions['dropField']   = '刪除資料庫表 %TABLE% 的 %FIELD% 欄位';
$lang->install->changeActions['renameField'] = '修改資料庫表 %TABLE% 的 %OLD% 欄位的名稱為 %NEW%';
$lang->install->changeActions['addIndex']    = '給資料庫表 %TABLE% 添加 %INDEX% 索引';
$lang->install->changeActions['dropIndex']   = '刪除資料庫表 %TABLE% 的 %INDEX% 索引';
$lang->install->changeActions['insertValue'] = '給資料庫表 %TABLE% 插入數據';
$lang->install->changeActions['updateValue'] = '更新資料庫表 %TABLE% 的數據';
$lang->install->changeActions['deleteValue'] = '從資料庫表 %TABLE% 刪除數據';
