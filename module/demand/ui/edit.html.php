...
(
    ...
    (
        ...
        (
            ...
            item
            (
                set::trClass($demand->parent >= 0 ? '' : 'hidden'),
                set::name($lang->demand->parent),
                $demand->parent >= 0 ? picker(setID('parent'), set::name('parent'), set::items($parents), set::value($demand->parent)) : formHidden('parent', $demand->parent)
            ),
            item
            (
