...
class webhookModel extends model
{
     ...
     * @return string
     */
    public function getFeishuBoundOpenId($assignedTo)
    {
     ...
     * @return string
     */
    public function getDataByType($webhook, $action, $title, $text, $mobile, $email, $objectType, $objectID, $assignedTo = '')
    {
     ...
     * @return object
     */
    public function getFeishuData($title, $text, $atMarkdown = '')
    {
        $data = new stdclass();
