...
class pipeline extends control
{
     ...
     * @return void
     */
    public function commonAction($spaceID = 0)
    {
     ...
     * @return void
     */
    public function browse($space = 0, $repoID = 0, $type = 'space', $queryID = '', $orderBy = 'id_desc', $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
     ...
     * @return void
     */
    public function create($spaceID = 0, $repoID = 0)
    {
        if($_POST)
        {
     ...
     * @return void
     */
    public function edit($id, $spaceID = 0, $repoID = 0, $type = '')
    {
        if($_POST)
        {
     ...
     * @return void
     */
    public function exec($pipelineID, $space = 0, $repoID = 0, $type = 'space', $noVars = 0)
    {
     ...
     * @return void
     */
    public function ajaxGetRefList($repoID, $query = '')
    {
        $repo = $this->loadModel('repo')->getByID($repoID);
        $scm  = $this->app->loadClass('scm');
        $scm->setEngine($repo);
     ...
     * @return void
     */
    public function ajaxCheckSonarqubeLink($repoID, $pipelineID = 0)
    {
     ...
     * @return void
     */
    public function import($repoID = 0, $providerID = 0)
    {
        if($_POST)
        {
     ...
     * @return void
     */
    public function ajaxGetPipeline($pipelineID)
    {
        $pipeline = $this->pipeline->getByID($pipelineID);
     ...
     * @return void
     */
    public function execution($space = 0, $repoID = 0, $type = 'space', $pipelineID = 0, $queryID = '', $orderBy = 'id_desc', $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
        $this->commonAction($space);
     ...
     * @return void
     */
    public function ajaxGetFlowInfo($pipelineID)
    {
        $pipeline = $this->pipeline->getById($pipelineID);
     ...
     * @return void
     */
    public function ajaxPostFlowInfo($pipelineID)
    {
     ...
     * @return void
     */
    public function ajaxGetStepSchema($stepName)
    {
     ...
     * @return void
     */
    public function ajaxPostVars($pipelineID)
    {
     ...
     * @return void
     */
    public function ajaxEditPipeline($pipelineID, $type = 'draft')
    {
        if($_POST)
        {
            $object = new stdClass();
     ...
     * @return void
     */
    public function ajaxPostTrigger($pipelineID)
    {
     ...
     * @return void
     */
    public function ajaxTriggerForm($pipelineID, $triggerType = '')
    {
        $pipeline = $this->pipeline->getByID($pipelineID);
     ...
     * @return void
     */
    public function ajaxSaveTrigger($pipelineID)
    {
        $pipeline = $this->pipeline->getByID($pipelineID);
        if(empty($pipeline)) return $this->sendError('Pipeline not found');
     ...
     * @return void
     */
    public function ajaxDeleteTrigger($triggerID, $field = '')
    {
     ...
     * @return void
     */
    public function ajaxGetExecInfo($execID)
    {
     ...
     * @return void
     */
    public function execView($id, $space = 0, $repoID = 0, $type = 'space')
    {
     ...
     * @return void
     */
    public function getLog($pipelineID, $executionID, $stageID, $stepID)
    {
        $apiRoot = $this->loadModel('gitfox')->getApiRoot();
     ...
     * @return void
     */
    public function ajaxExecLog($id, $space = 0, $repoID = 0, $type = 'space')
    {
        $this->commonAction($space);
        if($repoID)
        {
