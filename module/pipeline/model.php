...
class pipelineModel extends model
{
     ...
     * @return array
     */
    public function getList($spaceID = 0, $repoID = 0, $type = '', $pipelineQuery = '', $orderBy = 'id_desc', $pager = null)
    {
     ...
     * @return array
     */
    public function getExecutionList($spaceID = 0, $repoID = 0, $type = '', $pipelineID = 0, $pipelineQuery = '', $orderBy = 'id_desc', $pager = null)
    {
     ...
     * @return array
     */
    public function getExecutionByPipeline($pipelineIdList, $showLast = false)
    {
     ...
     * @return string
     */
    public function getTriggerConfig($pipeline)
    {
        $triggerList = array();
     ...
     * @return object|false
     */
    public function exec($id, $variables)
    {
     ...
     * @return bool
     */
    public function execGitlabPipeline($pipeline, $triggerType = 'manual')
    {
     ...
     * @return bool
     */
    public function execJenkinsPipeline($pipeline, $triggerType = 'manual')
    {
        $provider = $this->loadModel('provider')->getByID($pipeline->providerID);
     ...
     * @return array
     */
    public function getBySpaces($spaceIdList)
    {
     ...
     * @return int|false
     */
    public function importFromProvider($repo, $formData)
    {
     ...
     * @return bool
     */
    public function isClickable($pipeline, $action)
    {
     ...
     * @return string
     */
    public function getStepSchema($stepName)
    {
        $apiRoot = $this->loadModel('gitfox')->getApiRoot();
     ...
     * @return bool
     */
    public function updateContent($pipelineID, $content)
    {
     ...
     * @return void
     */
    public function apiUpdateTrigger($pipelineID, $triggerID, $trigger)
    {
        $apiRoot = $this->loadModel('gitfox')->getApiRoot();
     ...
     * @return void
     */
    public function apiCreateTrigger($pipelineID, $trigger)
    {
        $apiRoot = $this->loadModel('gitfox')->getApiRoot();
     ...
     * @return array
     */
    public function parseTriggers($cron, $events)
    {
        $cron   = explode('|', $cron);
     ...
     * @return void
     */
    public function saveTrigger($trigger)
    {
     ...
     * @return array
     */
    public function getTriggers($pipelineID)
    {
     ...
     * @return void
     */
    public function updateTriggerField($triggerID, $field, $value)
    {
     ...
     * @return object|false
     */
    public function apiGetExecInfo($execID)
    {
        $apiRoot = $this->loadModel('gitfox')->getApiRoot();
     ...
     * @return object|false
     */
    public function getExecByID($execID)
    {
     ...
     * @return bool
     */
    public function handleWebhook($event, $data, $pipeline)
    {
        $eventMap = array(
            'Push Hook'          => 'push',
     ...
     * @return bool
     */
    public function addTriggerCronJob($pipelineID, $cronDef, $engine = 'gitlab')
    {
        $apiRoot = $this->loadModel('gitfox')->getApiRoot();
     ...
     * @return bool
     */
    public function deleteTriggerCronJob($pipelineID, $engine = 'gitlab')
    {
        $apiRoot = $this->loadModel('gitfox')->getApiRoot();
        if(!$apiRoot) return false;
     ...
     * @return bool
     */
    public function migrateJobsToOpsPipelines()
    {
     ...
     * @return array
     */
    public function getExternalPipeline($statusList = array())
    {
     ...
     * @return bool
     */
    public function syncExternalPipeline()
    {
