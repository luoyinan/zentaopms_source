...
class pipelineZen extends pipeline
{
     ...
     * @return string
     */
    public function getPipelineSearchQuery($queryID, $queryName = 'pipelineQuery')
    {
        if($queryID)
        {
     ...
     * @return void
     */
    public function getExistPipelines($repoID = 0)
    {
     ...
     * @return void
     */
    public function buildImportForm($repoID, $providerID = 0)
    {
     ...
     * @return array
     */
    public function getJenkinsPipelineList($providerID)
    {
     ...
     * @return array
     */
    private function buildJenkinsTree($tasks)
    {
        $result = array();
