...
class gitlabModel extends model
{
     ...
     * @return bool|array
     */
    public function addPushWebhook($pipelineID, $callbackToken, $url, $token = '', $projectID = '')
    {
     ...
     * @return bool
     */
    public function isWebhookExists($url, $token, $projectID, $callbackURL = '')
    {
        $apiRoot  = rtrim($url, '/') . "/api/v4%s?private_token={$token}";
     ...
     */
    public function apiCreatePipeline($url, $token, $projectID, $params)
    {
     ...
     * @return array|object
     */
    public function apiGetExecInfo($number, $pipelineName, $provider)
    {
     ...
     * @return string
     */
    public function getLogs($buildNumber, $pipelineName, $provider)
    {
