...
class repobranchrule extends control
{
     ...
     * @return void
     */
    public function setBranchRule($branchTypeID = 0, $repoID = 0, $branchRawName = '', $from = 'settings', $objectID = 0)
    {
     ...
     * @return void
     */
    public function ajaxDeleteBranchRule($branchTypeID, $repoID, $branchName, $ruleID, $from, $objectID = 0)
    {
