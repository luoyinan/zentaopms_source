...
class testcaseZen extends testcase
{
     ...
     * @return void
     */
    protected function processCaseForExport($case, $products = array(), $branches = array(), $users = array(), $results = array(), $relatedModules = array(), $relatedStories = array(),  $relatedCases = array(), $relatedSteps = array(), $relatedFiles = array(), $relatedScenes = array())
    {
        $case->stepDesc       = '';
        $case->stepExpect     = '';
        $case->real           = '';
     ...
     * @return void
     */
    protected function processLinkCaseForExport($case, $relatedCases = array())
    {
        $tmpLinkCases   = array();
        $hasFromCase    = false;
        if($case->linkCase)
