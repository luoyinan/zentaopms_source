...
$lang->misc->copyright   = "&copy; 2009 - " . date('Y') . " <a href='https://www.chandao.com' target='_blank'>禪道軟件（青島）集團有限公司</a> 電話：4006-8899-23 Email：<a href='mailto:co@zentao.net'>co@zentao.net</a>  QQ：1492153927";
...
/* Release Detail. */
$lang->misc->feature->all['22.4'][]        = array('title' => '細節功能完善支持在禪道智能會話中實時訪問和操作禪道數據。禪道智能體優化、skills管理。功能優化兼容旗艦版。', 'desc' => '');
$lang->misc->feature->all['22.3'][]        = array('title' => 'jira 數據api導入機制優化。發佈。發佈。發佈。', 'desc' => '');
$lang->misc->feature->all['22.2'][]        = array('title' => '.工作流重構。項目流程配置功能優化。兼容旗艦版。', 'desc' => '');
