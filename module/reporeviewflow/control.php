...
class reporeviewflow extends control
{
     ...
     * @return void
     */
    public function browse($repoID, $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
     ...
     * @return void
     */
    public function edit($repoID, $flowID)
    {
        $this->loadModel('ci')->setMenu($repoID);
        $repo        = $this->loadModel('repo')->getByID($repoID);
     ...
     * @return void
     */
    public function changeStatus($flowID, $status)
    {
