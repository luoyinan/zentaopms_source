...
class reporeviewflowModel extends model
{
     ...
     * @return array
     */
    public function getList($repoID, $pager = null)
    {
     ...
     * @return int|false
     */
    public function create($repoID, $data)
    {
     ...
     * @return bool
     */
    public function update($flow, $data)
    {
        $reviewFlow = new stdClass();
        $reviewFlow->name       = $data->name;
        $reviewFlow->desc       = $data->desc;
     ...
     * @return object|false
     */
    public function getByID($reviewFlowID)
    {
     ...
     * @return bool
     */
    public function updateStatus($reviewFlowID, $status)
    {
     ...
     * @return bool
     */
    public static function isClickable($reviewFlow, $action)
    {
     ...
     * @return array|object
     */
    public function getByBranchName($repoID, $branchName)
    {
     ...
     * @return array
     */
    public function getPairs($repoID = 0, $status = '')
    {
