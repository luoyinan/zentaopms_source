...
$lang->action->repoDeleted  = '代碼庫已刪除, 無法恢復。';
...
$lang->action->taskHasParentStage  = '該任務所屬階段是父階段，無法恢復。';
...
$lang->action->objectTypes['pipeline']         = '流水綫';
$lang->action->objectTypes['ppm']              = '評審請求';
...
$lang->action->objectTypes['space']            = '空間';
$lang->action->objectTypes['review_flow']      = '評審流程';
...
$lang->action->objectTypes['ganttversion']     = '甘特圖版本';
$lang->action->objectTypes['projectchange']    = '項目變更';
$lang->action->objectTypes['artifact']         = '製品庫';
$lang->action->objectTypes['artifactasset']    = '製品';
$lang->action->objectTypes['artifactdir']      = '製品庫目錄';
$lang->action->objectTypes['gitfox']           = 'GitFox伺服器';
$lang->action->objectTypes['gitfoxuser']       = 'GitFox用戶';
$lang->action->objectTypes['repotag']          = '代碼標籤';
$lang->action->objectTypes['repobranch']       = '代碼分支';
$lang->action->objectTypes['pullreq']          = '推送請求';
$lang->action->objectTypes['runner']           = 'Runner';
$lang->action->objectTypes['codescanrule']     = '代碼掃瞄規則';
$lang->action->objectTypes['codescanruleset']  = '代碼掃瞄規則集';
$lang->action->objectTypes['codescansolution'] = '代碼掃瞄方案';
$lang->action->objectTypes['codescanplan']     = '代碼掃瞄計劃';
$lang->action->objectTypes['codescantrigger']  = '代碼掃瞄觸發器';
$lang->action->objectTypes['codescanissue']    = '代碼掃瞄問題';
$lang->action->objectTypes['codescantask']     = '代碼掃瞄任務';
$lang->action->objectTypes['compile']          = '流水綫執行記錄';
$lang->action->objectTypes['gitfoxbranch']     = '代碼分支';
$lang->action->objectTypes['provider']         = '服務';
...
$lang->action->desc->downloaded           = '$date, 由 <strong>$actor</strong> 下載。' . "\n";
$lang->action->desc->uploaded             = '$date, 由 <strong>$actor</strong> 上傳。' . "\n";
$lang->action->desc->copied               = '$date, 由 <strong>$actor</strong> 從 $extra 複製而來。' . "\n";
...
$lang->action->desc->autounlinkstory   = '$date, 由 <strong>$actor</strong> 關聯需求到 <strong>$extra</strong>計劃中,自動移除需求。' . "\n";
...
$lang->action->desc->deletedasset = '$date, 由 <strong>$actor</strong> 刪除' . "\n";
...
$lang->action->label->uploaded                = '上傳了';
$lang->action->label->moved                   = '移動了';
$lang->action->label->downloaded              = '下載了';
$lang->action->label->copied                  = '複製了';
...
$lang->action->label->createppm               = '關聯了';
$lang->action->label->deleteppm               = '取消了';
$lang->action->label->mergedppm               = '合併了';
...
$lang->action->label->editbranchtype          = '編輯了分支類型';
$lang->action->label->deletebranchtype        = '刪除了分支類型';
...
$lang->action->label->createrepotag           = '創建了標籤從';
$lang->action->label->createruleset           = '創建了規則集';
$lang->action->label->editruleset             = '編輯了規則集';
$lang->action->label->deleteruleset           = '刪除了規則集';
$lang->action->label->enableruleset           = '啟用了規則集';
$lang->action->label->disableruleset          = '關閉了規則集';
$lang->action->label->createpullreq           = '關聯了';
$lang->action->label->deletepullreq           = '取消了';
$lang->action->label->mergedpullreq           = '推送了';
$lang->action->label->enablescanrule          = '啟用了';
$lang->action->label->disablescanrule         = '禁用了';
$lang->action->label->enablescanruleset       = '啟用了';
$lang->action->label->disablescanruleset      = '禁用了';
$lang->action->label->createruleset           = '添加了';
$lang->action->label->editruleset             = '編輯了';
$lang->action->label->deleteruleset           = '刪除了';
$lang->action->label->enablescansolution      = '啟用了';
$lang->action->label->disablescansolution     = '禁用了';
$lang->action->label->createsolution          = '添加了';
$lang->action->label->editsolution            = '編輯了';
$lang->action->label->deletesolution          = '刪除了';
$lang->action->label->unlinkrule              = '解除關聯了規則';
$lang->action->label->linkrule                = '關聯了規則';
$lang->action->label->unlinkruleset           = '解除關聯了規則集';
$lang->action->label->linkruleset             = '關聯了規則集';
$lang->action->label->createplan              = '添加了';
$lang->action->label->editplan                = '編輯了';
$lang->action->label->deleteplan              = '刪除了';
$lang->action->label->unlinksolution          = '解除關聯瞭解決方案';
$lang->action->label->exec                    = '執行了';
$lang->action->label->resend                  = '重試了';
$lang->action->label->resendCompile           = '回放了';
$lang->action->label->enabledrunner           = '啟用了';
$lang->action->label->disabledrunner          = '停用了';
$lang->action->label->createrule              = '創建了規則';
$lang->action->label->editrule                = '編輯了規則';
$lang->action->label->deleterule              = '刪除了規則';
$lang->action->label->enablerule              = '啟用了規則';
$lang->action->label->disablerule             = '關閉了規則';
$lang->action->label->editedasset             = '編輯了';
$lang->action->label->movedasset              = '移動了';
$lang->action->label->deletedasset            = '刪除了';
...
$lang->action->label->deletewebhook  = '刪除了Webhook';
$lang->action->label->createwebhook  = '創建了Webhook';
$lang->action->label->editwebhook    = '編輯了Webhook';
$lang->action->label->enablewebhook  = '啟用了Webhook';
$lang->action->label->disablewebhook = '關閉了Webhook';
...
$lang->action->label->space        = '空間|space|view|id=%s';
$lang->action->label->deliverable  = '交付物類型|deliverable|view|id=%s';

$lang->action->label->enablereviewflow  = '啟用';
...
$lang->action->apiTitle->downloaded            = '下載';
...
$lang->action->desc->deleteppm                    = '$date, 由 <strong>$actor</strong> 取消關聯了 <a href="$extra">合併請求</a>。';
$lang->action->desc->mergedppm                    = '$date, 由 <strong>$actor</strong> 合併了代碼';
...
$lang->action->desc->createrepotag                = '$date, 由 <strong>$actor</strong> 創建了代碼標籤 <strong>$extra</strong>。' . "\n";
$lang->action->desc->createpullreq                = '$extra';
$lang->action->desc->deletepullreq                = '$date, 由 <strong>$actor</strong> 取消關聯了 <a href="$extra">推送請求</a>。';
$lang->action->desc->mergedpullreq                = '$date, 由 <strong>$actor</strong> 推送了代碼';
$lang->action->desc->enablescanrule               = '$date, 由 <strong>$actor</strong> 啟用。';
$lang->action->desc->disablescanrule              = '$date, 由 <strong>$actor</strong> 禁用。';
$lang->action->desc->enablescanruleset            = '$date, 由 <strong>$actor</strong> 啟用。';
...
$lang->action->desc->editruleset                  = '$date, 由 <strong>$actor</strong> 編輯。';
$lang->action->desc->deleteruleset                = '$date, 由 <strong>$actor</strong> 刪除。';
$lang->action->desc->enablescansolution           = '$date, 由 <strong>$actor</strong> 啟用。';
...
$lang->action->desc->editsolution                 = '$date, 由 <strong>$actor</strong> 編輯。';
$lang->action->desc->deletesolution               = '$date, 由 <strong>$actor</strong> 刪除。';
$lang->action->desc->unlinkrule                   = '$date, 由 <strong>$actor</strong> 解除關聯了規則。';
$lang->action->desc->linkrule                     = '$date, 由 <strong>$actor</strong> 關聯了規則。';
$lang->action->desc->unlinkruleset                = '$date, 由 <strong>$actor</strong> 解除關聯了規則集。';
$lang->action->desc->linkruleset                  = '$date, 由 <strong>$actor</strong> 關聯了規則集。';
$lang->action->desc->createplan                   = '$date, 由 <strong>$actor</strong> 添加。';
$lang->action->desc->editplan                     = '$date, 由 <strong>$actor</strong> 編輯。';
$lang->action->desc->deleteplan                   = '$date, 由 <strong>$actor</strong> 刪除。';
$lang->action->desc->unlinksolution               = '$date, 由 <strong>$actor</strong> 解除關聯瞭解決方案。';
$lang->action->desc->exec                         = '$date, 由 <strong>$actor</strong> 執行代碼掃瞄任務。';
$lang->action->desc->resend                       = '$date, 由 <strong>$actor</strong> 發起重試。';
$lang->action->desc->resendCompile                = '$date, 由 <strong>$actor</strong> 發起回放。';
...
$lang->action->label->addreviewer    = '添加了評審人';
$lang->action->label->deletereviewer = '刪除了評審人';
$lang->action->desc->addreviewer     = '$date, <strong>$actor</strong> 添加了評審人<strong>$extra</strong>。';
$lang->action->desc->deletereviewer  = '$date, <strong>$actor</strong> 刪除了評審人<strong>$extra</strong>。';
