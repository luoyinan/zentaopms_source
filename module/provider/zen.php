...
class providerZen extends provider
{
     ...
     * @return bool
     */
    public function checkServiceUrl($provider)
    {
     ...
     * @return bool
     */
    protected function checkSubversionUrl($url)
    {
     ...
     * @return bool
     */
    protected function isValidSubversionUrl($url)
    {
        $parts = parse_url($url);
     ...
     * @return bool
     */
    protected function isAccessibleSubversionUrl($url)
    {
        $parts  = parse_url($url);
        $scheme = strtolower((string)zget($parts, 'scheme', ''));
     ...
     * @return bool
     */
    protected function checkSubversionHttpUrl($url)
    {
     ...
     * @return bool
     */
    protected function checkSubversionSocket($host, $port = 3690)
    {
        $errno   = 0;
        $error   = '';
     ...
     * @return bool
     */
    protected function checkSubversionFilePath($path)
    {
     ...
     * @return string
     */
    protected function getCheckApiUrl($type, $url)
    {
        $url   = rtrim($url, '/');
        $parts = parse_url($url);
     ...
     * @return array
     */
    protected function getCheckHeaders($type, $token)
    {
