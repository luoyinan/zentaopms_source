...
class release extends control
{
     ...
     * @return string
     */
    private function getBranchForMenu($release)
    {
     ...
     * @return void
     */
    public function browse($productID, $branch = 'all', $browseType = 'all', $orderBy = 't1.date_desc', $param = '', $recTotal = 0, $recPerPage = 20, $pageID = 1, $from = 'product', $blockID = 0)
    {
        if($from === 'doc' || $from == 'ai')
        {
