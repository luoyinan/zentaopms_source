...
EOF;
     ...
     * @return void
     */
    public function resetDevOpsPriv($spaceID = 0)
    {
        $module = $this->app->getModuleName();
        $method = $this->app->getMethodName();
