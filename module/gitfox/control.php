...
class gitfox extends control
{
     ...
     * @return void
     */
    public function ajaxGetProjectBranches($repoID)
    {
     ...
     * @return void
     */
    public function devopsIntroduction($isInstall = 0)
    {
     ...
     * @return void
     */
    public function installGitFox($inPage = 'devops', $skipInstall = 0, $fromVersion = '')
    {
