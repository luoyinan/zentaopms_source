...
class gitfoxModel extends model
{
     ...
     * @return object|array|bool
     */
    public function getResponse($response, $parseError = false)
    {
     ...
     */
    public function apiCreateBranch( $projectID, $branch)
    {
     ...
     */
    public function apiCreateTag($projectID, $tag)
    {
     ...
     */
    public function apiGetSingleRepo($repoID)
    {
     ...
     * @return object|null
     */
    public function apiGetMirrorSyncProgress($repoID)
    {
        $apiRoot = $this->getApiRoot();
     ...
     * @return object|array|bool
     */
    public function apiMirrorSync($repoID)
    {
        $apiRoot = $this->getApiRoot();
     ...
     * @return array
     */
    public function apiGetRepos($query = '')
    {
        $apiRoot = $this->getApiRoot();
     ...
     * @return bool
     */
    public function updateCodePath($repoID, $id)
    {
     ...
     */
    public function apiGetHooks($repoID, $hookID = 0, $params = array())
    {
     ...
     * @return object|array|false
     */
    public function apiCreateHook($repoID, $hook)
    {
     ...
     * @return object|false
     */
    public function apiCreateRepo($repo)
    {
     ...
     * @return array
     */
    public function apiGetGroups($gitfoxID, $orderBy = 'id_desc', $minRole = false, $keyword = '')
    {
     ...
     * @return bool
     */
    public function apiDeleteBranch($repoID, $branch)
    {
        $apiRoot = $this->getApiRoot();
        if(!$apiRoot) return false;
     ...
     * @return object|array|null
     */
    public function apiGetSinglePipeline($gitfoxID, $projectID, $pipelineID, $executionID)
    {
     ...
     * @return object|array|null
     */
    public function apiGetPipeline($gitfoxID, $projectID, $branch = '')
    {
     ...
     * @return string
     */
    public function apiGetPipelineLogs($gitfoxID, $projectID, $pipeline)
    {
     ...
     * @return object|false
     */
    public function apiCreateSpace($space)
    {
        $apiRoot = $this->getApiRoot();
        $url     = sprintf($apiRoot->url, '/spaces');
     ...
     * @return object|array|false
     */
    public function apiUpdateWebhook($repoID, $webhookID, $data)
    {
     ...
     */
    public function apiGetWebhookExecution($repoID, $webhookID, $executionID = 0, $params = array())
    {
     ...
     * @return object|array|bool
     */
    public function apiDeleteWebhook($repoID, $webhookID)
    {
     ...
     * @return object|bool
     */
    public function apiCreateBranchType($gitfoxID, $branchtype)
    {
        $apiRoot = $this->getApiRoot();
     ...
     * @return bool
     */
    public function apiDeleteBranchType($repoID, $typeID)
    {
        $apiRoot = $this->getApiRoot();
     ...
     * @return bool
     */
    public function apiUpdateBranchType($repoID, $typeID, $branchtype)
    {
        $apiRoot = $this->getApiRoot();
        $url     = sprintf($apiRoot->url, "/repos/{$repoID}/branch-types/{$typeID}");
     ...
     * @return bool
     */
    public function apiUpdateSpace($spaceID, $data)
    {
        $apiRoot = $this->getApiRoot();
     ...
     * @return array
     */
    public function apiGetSpaces($query, $pager = null)
    {
        $apiRoot = $this->getApiRoot();
        $url     = sprintf($apiRoot->url, '/spaces');
     ...
     * @return object|array
     */
    public function apiGetSpace($spaceID)
    {
        $apiRoot = $this->getApiRoot();
        $url     = sprintf($apiRoot->url, '/spaces' . "/{$spaceID}");
     ...
     * @return bool
     */
    public function apiDeleteSpace($spaceID)
    {
        $apiRoot = $this->getApiRoot();
        $url     = sprintf($apiRoot->url, '/spaces' . "/{$spaceID}");
     ...
     * @return bool
     */
    public function apiDeleteTag($repoID, $tag)
    {
        $apiRoot = $this->getApiRoot();
        if(!$apiRoot) return false;
     ...
     * @return bool
     */
    public function apiRestoreSpace($spaceID)
    {
        $apiRoot = $this->getApiRoot();
     ...
     * @return object|bool
     */
    public function apiGetCommits($repoID, $params)
    {
        $apiRoot = $this->getApiRoot();
     ...
     * @return object|bool
     */
    public function apiGetMergeCheckMessage($repoID, $source, $target, $type = 'branch')
    {
        if($type == 'branch')
        {
     ...
     * @return object|bool
     */
    public function apiGetDiffStats($repoID, $source, $target, $type = 'branch')
    {
        if($type == 'branch')
        {
            $source = 'refs/heads/' . $source;
     ...
     * @return void
     */
    public function apiUpdateRepo($repoID, $repo)
    {
        $apiRoot = $this->getApiRoot();
        $url     = sprintf($apiRoot->url, "/repos/{$repoID}");
