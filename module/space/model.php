...
class spaceModel extends model
{
     ...
     * @return array
     */
    public function getPairs($account = '', $filterRepoCreate = false)
    {
     ...
     * @return array
     */
    public function getByIdList($spaceIdList = array(), $showDeleted = true)
    {
        $query = array();
     ...
     * @return bool|array
     */
    public function update($space, $formData)
    {
     ...
     * @return array
     */
    public function getReposBySpace($spaceID, $acl = '')
    {
     ...
     * @return array
     */
    public function getArtifactLibsBySpace($spaceID)
    {
     ...
     * @return array
     */
    public function getPipelineBySpace($spaceID)
    {
     ...
     * @return array
     */
    public function getSystemBySpace($spaceID)
    {
     ...
     * @return void
     */
    public function setMenu($spaceID = 0)
    {
     ...
     */
    public function getDevOpsAllPrivs()
    {
        $privs = array();
        foreach($this->lang->resource as $module => $methods)
        {
     ...
     * @return array
     */
    public function getSpaceUsers($spaceID, $role = '')
    {
     ...
     * @return array
     */
    public function getRepoUsersBySpace($spaceID = 0)
    {
     ...
     * @return array
     */
    public function getGroupMembersBySpace($spaceID = 0, $allVision = false)
    {
     ...
     * @return array
     */
    public function getSpaceMembers($spaceID, $allVision = false)
    {
        $members     = array();
     ...
     * @return bool
     */
    public function manageMembers($spaceID, $members)
    {
     ...
     * @return bool
     */
    public function removeMember($spaceID, $account)
    {
     ...
     * @return bool
     */
    public function restore($spaceID, $actionID)
    {
     ...
     * @return array
     */
    public function getProductsBySpace($spaceID, $hasPairs = false)
    {
     ...
     * @return bool
     */
    public static function isClickable($space, $action)
    {
     ...
     * @return bool
     */
    public function createDefaultSpace()
    {
     ...
     * @return bool
     */
    public function migrateGroupPrivs()
    {
