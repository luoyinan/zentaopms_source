...
class space extends control
{
     ...
     * @return void
     */
    public function ajaxGetDropMenu($spaceID, $module = 'repo', $method = 'maintain')
    {
     ...
     * @return void
     */
    public function createGroup($spaceID)
    {
        $this->loadModel('group');
        if(!empty($_POST))
        {
     ...
     * @return void
     */
    public function managePriv($spaceID, $groupID = 0, $type = 'byPackage')
    {
        $this->loadModel('group');
     ...
     * @return void
     */
    public function members($spaceID)
    {
        $this->space->setMenu($spaceID);
     ...
     * @return void
     */
    public function manageMembers($spaceID)
    {
        $this->space->setMenu($spaceID);
     ...
     * @return void
     */
    public function ajaxTips($spaceID)
    {
        $this->space->setMenu($spaceID);
     ...
     * @return void
     */
    public function importGroup($spaceID)
    {
        $this->loadModel('group');
        if(!empty($_POST))
        {
     ...
     * @return void
     */
    public function ajaxGetGroupsBySpace($spaceID)
    {
     ...
     * @return void
     */
    public function ajaxGetGroupByID($groupID)
    {
