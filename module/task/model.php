...
class taskModel extends model
{
     ...
     * @return object[]
     */
    public function getByIdList($taskIdList = array(), $orderBy = '')
    {
     ...
     * @return object[]
     */
    public function getListByStory($storyID, $executionID = 0, $projectID = 0, $isTree = true)
    {
     ...
     * @return bool
     */
    public function sendMessageForRelationTask($taskID, $action, $actionID)
    {
     ...
     * @return bool
     */
    public function sendMailForRelationTask($task, $relationTasks, $action)
    {
        $this->loadModel('mail');
     ...
     * @return bool
     */
    public function sendWebhookForRelationTask($task, $relationTasks, $action, $actionID)
    {
