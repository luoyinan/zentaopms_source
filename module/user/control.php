...
class user extends control
{
     ...
     * @return void
     */
    public function story($userID, $storyType = 'story', $browseType = 'assignedTo', $orderBy = 'id_desc', $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
        /* Save session. */
     ...
     * @return void
     */
    public function task($userID, $browseType = 'assignedTo', $orderBy = 'id_desc', $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
        /* Save the session. */
     ...
     * @return void
     */
    public function bug($userID, $browseType = 'assignedTo', $orderBy = 'id_desc', $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
        /* Save the session. */
     ...
     * @return void
     */
    public function issue($userID, $browseType = 'assignedTo', $orderBy = 'id_desc', $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
     ...
     * @return void
     */
    public function risk($userID, $browseType = 'assignedTo', $orderBy = 'id_desc', $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
     ...
     * @return void
     */
    public function ajaxGetItems($params = '', $search = '', $maxCount = 0)
    {
        $items  = array();
