...
class execution extends control
{
     ...
     * @return void
     */
    public function task($executionID = 0, $browseType = 'unclosed', $param = 0, $orderBy = '', $recTotal = 0, $recPerPage = 100, $pageID = 1, $from = 'execution', $blockID = 0)
    {
     ...
     * @return void
     */
    public function story($executionID = 0, $storyType = 'story', $orderBy = 'order_desc', $browseType = 'all', $param = 0, $recTotal = 0, $recPerPage = 50, $pageID = 1, $from = 'execution', $blockID = 0)
    {
        /* Load these models. */
     ...
     * @return void
     */
    public function bug($executionID = 0, $productID = 0, $branch = 'all', $orderBy = 'status,id_desc', $build = '', $browseType = 'all', $param = 0, $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
     ...
     * @return void
     */
    public function testcase($executionID = 0, $productID = 0, $branchID = 'all', $browseType = 'all', $param = 0, $moduleID = 0, $orderBy = 'id_desc', $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
     ...
     * @return void
     */
    public function build($executionID = 0, $browseType = 'all', $param = 0, $orderBy = 't1.date_desc,t1.id_desc', $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
        $execution   = $this->commonAction($executionID);
     ...
     * @return void
     */
    public function all($browseType = 'undone', $orderBy = 'order_asc', $productID = 0, $param = '', $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
