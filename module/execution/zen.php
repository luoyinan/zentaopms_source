...
class executionZen extends execution
{
     ...
     * @return void
     */
    protected function assignBugVars($execution, $project, $productID, $branch, $products, $orderBy, $browseType, $param, $build, $bugs, $pager)
    {
     ...
     * @return void
     */
    protected function assignTestcaseVars($executionID, $productID, $branchID, $moduleID, $param, $orderBy, $browseType, $pager)
    {
        $this->loadModel('tree');
