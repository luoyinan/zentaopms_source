...
class ppmZen extends ppm
{
     ...
     * @return void
     */
    protected function buildLinkStorySearchForm($ppmID, $repoID, $orderBy, $queryID = 0)
    {
     ...
     * @return void
     */
    protected function buildLinkBugSearchForm($ppmID, $repoID, $orderBy, $queryID = 0)
    {
        if(empty($this->product)) $this->loadModel('product');
     ...
     * @return void
     */
    protected function buildLinkTaskSearchForm($ppmID, $repoID, $orderBy, $queryID, $productExecutions)
    {
     ...
     * @return string
     */
    public function parseCreateCheckMsg($mergeCheckMessage, $mergeRuleResult, $sourceBranch, $targetBranch)
    {
     ...
     * @return object
     */
    public function getCheckResult($ppm, $reviewResult, $issues = array(), $mergeType = 'rebase')
    {
        $result = new stdClass();
