...
class ppmModel extends model
{
     ...
     * @return bool
     */
    public function createMRLinkedAction($id, $action, $actionDate = '')
    {
     ...
     * @return array|null
     */
    public function apiGetMRCommits($targetRepoID, $ppmID, $pager = null)
    {
     ...
     * @return bool
     */
    public function review($ppmID, $formData, $account = '')
    {
     ...
     * @return array
     */
    public function getLinkList($ppmID, $type, $orderBy = 'id_desc', $pager = null)
    {
     ...
     * @return bool
     */
    public function link($ppmID, $type, $objects)
    {
     ...
     * @return bool
     */
    public function linkObjects($ppm)
    {
        /* Get commits by MR. */
     ...
     * @return bool
     */
    public function unlink($ppmID, $type, $objectID)
    {
        if(!isset($this->config->objectTables[$type])) return false;
     ...
     * @return array
     */
    public function checkSameOpened($repoID, $sourceRepoID, $sourceBranch, $targetRepoID, $targetBranch)
    {
     ...
     * @return bool
     */
    public static function isClickable($ppm, $action)
    {
        global $app;
     ...
     * @return bool
     */
    public function execJob($ppmID, $jobID)
    {
     ...
     * @return array
     */
    public function getCommitListByBranch($repo, $sourceBranch, $targetBranch, $pager = null)
    {
       $params = array();
     ...
     * @return void
     */
    public function getRelationByBranch($repo, $sourceBranch, $targetBranch, $type = '', $pager = null)
    {
        if($type == 'all') $type = '';
        $params = array();
        $params['gitRef']   = $sourceBranch;
     ...
     * @return array
     */
    public function getReviewers($ppmID)
    {
     ...
     * @return bool
     */
    public function addReviewers($ppm, $reviewers)
    {
     ...
     * @return bool
     */
    public function deleteReviewer($ppmID, $reviewer)
    {
     ...
     * @return string
     */
    public function getReviewResult($reviewers, $flow)
    {
     ...
     * @return array
     */
    public function getReviewResults($ppmList, $repoID)
    {
     ...
     * @return object|bool
     */
    public function merge($ppmID, $mergeType, $dryRun = false, $byPass = false)
    {
     ...
     * @return array
     */
    public function checkMergeRule($repoID, $sourceBranch, $targetBranch)
    {
     ...
     * @return object|bool
     */
    public function apiTriggerEvent($repoID, $ppmID, $type)
    {
        $apiRoot = $this->loadModel('gitfox')->getApiRoot();
     ...
     * @return array
     */
    public function getPipelinesByPPM($ppm)
    {
     ...
     * @return array
     */
    public function getBugsByCommits($repoID, $ppmID, $pager = null)
    {
