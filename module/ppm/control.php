...
class ppm extends control
{
     ...
     * @return void
     */
    public function create($repoID = 0, $objectID = 0, $sourceBranch = '', $targetBranch = '')
    {
     ...
     * @return void
     */
    public function view($id, $type = 'basic', $param = 'all', $recTotal = 0, $recPerPage = 20, $pageID = 0)
    {
        $ppm  = $this->ppm->fetchByID($id);
     ...
     * @return void
     */
    public function link($id, $type = 'story', $orderBy = 'id_desc', $param = '', $recPerPage = 20, $pageID = 1)
    {
        $ppm     = $this->ppm->fetchByID($id);
     ...
     * @return void
     */
    public function linkStory($id, $repoID = 0, $browseType = '', $param = 0, $orderBy = 'id_desc', $recTotal = 0, $recPerPage = 10, $pageID = 1)
    {
     ...
     * @return void
     */
    public function linkBug($id, $repoID = 0, $browseType = '', $param = 0, $orderBy = 'id_desc', $recTotal = 0, $recPerPage = 10, $pageID = 1)
    {
        if(!empty($_POST['bugs']))
        {
     ...
     * @return void
     */
    public function linkTask($id, $repoID = 0, $browseType = 'unclosed', $param = 0, $orderBy = 'id_desc', $recTotal = 0, $recPerPage = 10, $pageID = 1)
    {
     ...
     * @return void
     */
    public function unlink($id, $type, $linkID)
    {
     ...
     * @return void
     */
    public function ajaxGetCreateCheckList($repoID, $sourceBranch, $targetBranch, $recPerPage = 20, $pageID = 1)
    {
        $sourceBranch = helper::safe64Decode($sourceBranch);
        $targetBranch = helper::safe64Decode($targetBranch);
     ...
     * @return void
     */
    public function ajaxGetConflictFiles($repoID, $sourceBranch, $targetBranch)
    {
        $sourceBranch = helper::safe64Decode($sourceBranch);
        $targetBranch = helper::safe64Decode($targetBranch);
     ...
     * @return void
     */
    public function ajaxGetReviewers($ppmID, $type = '')
    {
     ...
     * @return void
     */
    public function ajaxAddReviewers($ppmID, $type = 'basic')
    {
        $ppm = $this->ppm->fetchByID($ppmID);
        if($_POST)
        {
     ...
     * @return void
     */
    public function ajaxDeleteReviewer($ppmID, $reviewer, $type = 'basic')
    {
     ...
     * @return void
     */
    public function merge($ppmID, $mergeType)
    {
     ...
     * @return void
     */
    public function ajaxCheckReviewFlow($ppmID)
    {
        $ppm = $this->ppm->fetchByID($ppmID);
        $flow = $this->loadModel('reporeviewflow')->getByID(zget($ppm, 'reviewFlowID', 0));
