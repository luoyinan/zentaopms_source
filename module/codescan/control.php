...
class codescan extends control
{
     ...
     * @return void
     */
    public function browse($type = 'all', $language = '', $queryID = '', $orderBy = '', $recPerPage = 20, $pageID = 1)
    {
     ...
     * @return void
     */
    public function ruleset($type = 'all', $queryID = '', $orderBy = 'langID_desc',$recPerPage = 20, $pageID = 1)
    {
        $this->codescanZen->commonData();
     ...
     * @return void
     */
    public function changeState($ruleID, $status)
    {
     ...
     * @return void
     */
    public function editRuleset($setID)
    {
     ...
     * @return void
     */
    public function deleteRuleset($setID)
    {
     ...
     * @return void
     */
    public function changeRulesetState($rulesetID, $status)
    {
     ...
     * @return void
     */
    public function rulesetView($setID, $type = 'rule', $language = '', $orderBy = '', $recPerPage = 20, $pageID = 1)
    {
        $this->codescanZen->commonData('lang|plugin');
     ...
     * @return void
     */
    public function unlinkRule($setID, $ruleID)
    {
        $ruleSet = $this->codescan->getRuleset($setID);
     ...
     * @return void
     */
    public function batchUnlinkRule($setID)
    {
        if($_POST)
        {
     ...
     * @return void
     */
    public function linkRule($setID, $type = 'all', $orderBy = '', $recPerPage = 20, $pageID = 1)
    {
        $ruleSet = $this->codescan->getRuleset($setID);
        if($_POST)
        {
     ...
     * @return void
     */
    public function solution($type = 'all', $queryID = '', $orderBy = 'id_desc', $recPerPage = 20, $pageID = 1)
    {
        $this->codescanZen->commonData();
     ...
     * @return void
     */
    public function changeSolutionState($solutionID, $status)
    {
     ...
     * @return void
     */
    public function editSolution($solutionID)
    {
        $solution = $this->codescan->getSolution($solutionID);
     ...
     * @return void
     */
    public function linkSet($solutionID, $type = 'all', $orderBy = '', $recPerPage = 20, $pageID = 1)
    {
        $solution = $this->codescan->getSolution($solutionID);
     ...
     * @return void
     */
    public function solutionView($solutionID, $onlyRuleSet = 0)
    {
        $this->codescanZen->commonData('lang|plugin');
     ...
     * @return void
     */
    public function unlinkSet($solutionID, $setID)
    {
     ...
     * @return void
     */
    public function createPlan($repoID = 0)
    {
        if($_POST)
        {
     ...
     * @return void
     */
    public function editPlan($planID, $serviceRepoID, $repoID = 0)
    {
     ...
     * @return void
     */
    public function plan($repoID = 0, $status = 'all', $orderBy = 'id_desc', $recPerPage = 20, $pageID = 1)
    {
        $this->loadModel('repo');
        if($repoID)
        {
     ...
     * @return void
     */
    public function deletePlan($serviceRepoID, $planID, $repoID = 0)
    {
     ...
     * @return void
     */
    public function planView($serviceRepoID, $planID, $repoID = 0, $type = '', $orderBy = 'createAt_desc', $recPerPage = 20, $pageID = 1)
    {
        $this->codescanZen->commonData('lang');
     ...
     * @return void
     */
    public function unlinkSolution($serviceRepoID, $planID, $solutionID)
    {
     ...
     * @return void
     */
    public function task($repoID = 0, $serviceRepoID = 0, $planID = 0, $type = 'all', $queryID = '', $orderBy = 'id_desc', $recPerPage = 20, $pageID = 1)
    {
        $this->loadModel('repo');
        if($repoID)
        {
     ...
     * @return void
     */
    public function ajaxGetTaskLog($repoID, $pipelineName, $executionID)
    {
     ...
     * @return void
     */
    public function taskView($serviceRepoID, $taskID, $repoID = 0, $type = 'issue')
    {
        if($repoID) $this->loadModel('ci')->setMenu($repoID);
     ...
     * @return void
     */
    public function taskLog($serviceRepoID, $taskID, $repoID = 0)
    {
        $gitfoxRepos = $this->loadModel('repo')->getGitFoxRepos();
        $repoList    = array_column($gitfoxRepos, 'name', 'serviceProject');
        $task        = $this->codescan->getScanTask($taskID, $serviceRepoID);
     ...
     * @return void
     */
    public function exec($planID, $repoID)
    {
        $repo = $this->loadModel('repo')->fetchByID($repoID);
     ...
     * @return void
     */
    public function ajaxGetBranchByPlan($planID, $repoID)
    {
     ...
     * @return void
     */
    public function issue($repoID = 0, $taskID = 0, $serviceRepoID = 0, $type = 'wait', $queryID = '', $severity = '', $extras = '', $orderBy = 'id_desc', $recPerPage = 20, $pageID = 1)
    {
     ...
     * @return void
     */
    public function issueView($issueID, $repoID = 0)
    {
        if($repoID)
        {
            global $lang;
     ...
     * @return void
     */
    public function overview($repoID = 0)
    {
        if($repoID)
        {
            $this->loadModel('ci')->setMenu($repoID);
     ...
     * @return void
     */
    public function ajaxGetRepoIssueStatistics($repoID = 0)
    {
        $addedList = array();
        $fixedList = array();
        $closedNum = 0;
     ...
     * @return void
     */
    public function ajaxGetIssueResolvedByTop($repoID)
    {
     ...
     * @return void
     */
    public function ajaxGetIssueTrends($repoID, $day = 7)
    {
        $addedList = array();
        $fixedList = array();
        if($repoID)
     ...
     * @return void
     */
    public function tips($planID, $repoID, $serviceRepoID)
    {
        if($repoID) $this->loadModel('ci')->setMenu($repoID);
