...
class codescanModel extends model
{
     ...
     * @return bool
     */
    public function isClickable($codeScan, $action)
    {
     ...
     * @return array|object
     */
    public function getScanRulesets($params)
    {
     ...
     * @return array|object
     */
    public function getScanRulesetRules($rulesetID, $param)
    {
     ...
     * @return array|object
     */
    public function getScanRulesetUnlinkRules($rulesetID, $param)
    {
     ...
     * @return int|false
     */
    public function createRuleset($formData)
    {
     ...
     * @return object|false
     */
    public function getRuleset($rulesetID)
    {
     ...
     * @return bool
     */
    public function editRuleset($ruleID, $formData)
    {
        $apiRoot = $this->loadModel('gitfox')->getApiRoot();
     ...
     * @return bool
     */
    public function deleteRuleset($ruleID)
    {
     ...
     * @return array|object
     */
    public function getScanRules($params = array())
    {
        if(isset($params['id'])) $params['id'] = (int)$params['id'];
     ...
     * @return object
     */
    public function getScanRule($ruleID)
    {
     ...
     * @return array
     */
    public function getScanRulesConfig($type)
    {
     ...
     * @return bool
     */
    public function updateScanRuleStatus($ruleID)
    {
     ...
     * @return bool
     */
    public function updateScanRulesetStatus($rulesetID, $status = 'disabled')
    {
        $data = new stdclass();
     ...
     * @return bool
     */
    public function linkRulesInRuleset($rulesetID, $rules = array())
    {
     ...
     * @return bool
     */
    public function unlinkRules($rulesetID, $rules = array())
    {
        foreach($rules as &$value) $value = (int)$value;
     ...
     * @return array|object
     */
    public function getScanSolutions($params = array())
    {
        if(isset($params['id'])) $params['id'] = (int)$params['id'];
     ...
     * @return bool
     */
    public function updateSolutionStatus($solutionID)
    {
        $apiRoot = $this->loadModel('gitfox')->getApiRoot();
     ...
     * @return int|false
     */
    public function createSolution($formData)
    {
        $apiRoot = $this->loadModel('gitfox')->getApiRoot();
     ...
     * @return bool
     */
    public function bindRulesets($solutionID, $rulesets = array())
    {
     ...
     * @return bool
     */
    public function unbindRulesets($solutionID, $rulesets = array())
    {
        foreach($rulesets as &$value) $value = (int)$value;
     ...
     * @return bool
     */
    public function editSolution($solutionID, $formData)
    {
        $apiRoot = $this->loadModel('gitfox')->getApiRoot();
        $url     = sprintf($apiRoot->url, "/scan/solutions/{$solutionID}");
     ...
     * @return array|object
     */
    public function getSolutionUnlinkRulesets($solutionID, $param)
    {
        $apiRoot = $this->loadModel('gitfox')->getApiRoot();
        $url     = sprintf($apiRoot->url, "/scan/solutions/{$solutionID}/rulesets/unbind");
     ...
     * @return bool
     */
    public function linkRulesetInSolution($solutionID, $rulesets = array())
    {
        foreach($rulesets as &$value) $value = (int)$value;
     ...
     * @return array|object
     */
    public function getScanPlans($repoID, $params)
    {
        $apiRoot = $this->loadModel('gitfox')->getApiRoot();
     ...
     * @return array|object
     */
    public function getScanPlan($planID, $repoID)
    {
        $apiRoot = $this->loadModel('gitfox')->getApiRoot();
     ...
     * @return bool
     */
    public function deleteScanPlan($serviceRepoID, $planID)
    {
        $apiRoot = $this->loadModel('gitfox')->getApiRoot();
     ...
     * @return bool
     */
    public function batchCreateConditions($repoID, $planID, $conditions)
    {
        $apiRoot = $this->loadModel('gitfox')->getApiRoot();
     ...
     * @return array|object
     */
    public function getPlanConditions($repoID, $planID)
    {
        $apiRoot = $this->loadModel('gitfox')->getApiRoot();
     ...
     * @return bool
     */
    public function batchDeletePlanConditions($repoID, $planID, $conditions)
    {
        $apiRoot = $this->loadModel('gitfox')->getApiRoot();
     ...
     * @return bool
     */
    public function editPlan($repoID, $planID, $formData)
    {
        $apiRoot = $this->loadModel('gitfox')->getApiRoot();
        $url     = sprintf($apiRoot->url, "/scan/repos/{$repoID}/scanplans/{$planID}");
     ...
     * @return bool
     */
    public function bindOrUnbindSolutions($repoID, $planID, $solutions, $bind = true)
    {
        $apiRoot = $this->loadModel('gitfox')->getApiRoot();
     ...
     * @return array|object
     */
    public function getScanTasks($repoID, $planID, $params)
    {
     ...
     * @return array|object
     */
    public function getListByAPI($api, $params)
    {
        $apiRoot = $this->loadModel('gitfox')->getApiRoot();
     ...
     * @return array|object
     */
    public function getScanTask($taskID)
    {
        $apiRoot = $this->loadModel('gitfox')->getApiRoot();
     ...
     * @return object|false
     */
    public function execScanTask($plan, $branch)
    {
        $data = new stdclass();
        $data->branch = $branch;
        $data->planID = $plan->id;
     ...
     * @return void
     */
    public function changeIssueState($issueIdList, $status, $solution = '', $solutionDate = '', $ignoreDate = 0)
    {
     ...
     * @return object|array
     */
    public function getScanIssueList($taskID, $params = array())
    {
        if(isset($params['repoID']))   $params['repoID'] = (int)$params['repoID'];
     ...
     * @return object|array
     */
    public function getScanIssueListByIdList($issueIdList)
    {
        $IdList = array();
     ...
     * @return array|object
     */
    public function getScanIssue($issueID, $showBug = true)
    {
        $apiRoot = $this->loadModel('gitfox')->getApiRoot();
     ...
     * @return object
     */
    public function processIssueSnipe($issue)
    {
     ...
     * @return array
     */
    public function getLinkedBugList($issueList, $status = '')
    {
     ...
     * @return array
     */
    public function getIssueResolvedByTop($repoID = 0, $top = 10)
    {
     ...
     * @return array
     */
    public function getIssueTreeList($repoID, $taskID, $type = 'file')
    {
     ...
     * @return string
     */
    public function formatNumberToW($number)
    {
     ...
     * @return object|array
     */
    public function getRepoMetrics($repoID, $taskID = 0)
    {
        $url = '/scan/metrics';
     ...
     * @return array
     */
    public function getIssueTrendsByRepo($repoID, $beginDate = 0, $scope = 'day')
    {
        $apiRoot = $this->loadModel('gitfox')->getApiRoot();
