...
class codescanZen extends codescan
{
     ...
     * @return void
     */
    protected function buildParams($type, $params, $queryID = 0, $orderBy = '', $recPerPage = 20, $pageID = 1)
    {
     ...
     * @return void
     */
    protected function responseError($errors = '', $locate = '')
    {
     ...
     * @return array
     */
    protected function getListByQuery($query = 'ruleset', $serviceRepoID = 0, $taskID = 0, $status = '')
    {
        $list   = array();
        $page   = 1;
     ...
     * @return array
     */
    protected function processConditions($plan)
    {
     ...
     * @return object
     */
    protected function processPlanData($plan)
    {
        if(!empty($plan->repo))
        {
     ...
     * @return bool
     */
    public function validateTrigger(&$trigger)
    {
     ...
     * @return object
     */
    protected function buildPlanData($plan)
    {
     ...
     * @return object
     */
    protected function processTaskData($task, $repoList)
    {
     ...
     * @return object
     */
    protected function processIssueData($issue)
    {
     ...
     * @return array
     */
    protected function processExecBranch($planID, $repoID)
    {
     ...
     * @return void
     */
    protected function getFileIssueList($file, $serviceRepoID, $taskID)
    {
        $params = array();
     ...
     * @return object
     */
    protected function processRuleData($rule)
    {
     ...
     * @return array
     */
    protected function processIssueFileTree($fileTree, $urlParam, $params = array())
    {
     ...
     * @return array
     */
    protected function processIssueRuleTree($ruleTree, $urlParam, $params = array(), $ruleID = 0)
    {
        if(isset($params['branch'])) unset($params['branch']);
     ...
     * @return void
     */
    protected function assignTopIssueInjection($committers = array())
    {
        $statistics = array();
        if($committers)
        {
     ...
     * @return void
     */
    protected function assignRepoTopRanking($metrics, $type = 'rule', $taskID = 0)
    {
        $data = array();
     ...
     * @return array
     */
    protected function getIssueDistribution($metrics)
    {
        $data = array();
     ...
     * @return array
     */
    protected function processIssueTrends($metrics, $scope = 'day')
    {
        $addedList = array();
        $fixedList = array();
     ...
     * @return void
     */
    protected function repoIssueTopRanking($metrics, $type = 'total')
    {
        $data = array();
        if(!empty($metrics))
        {
     ...
     * @return void
     */
    protected function assignRepoStatistics($repoMetrics)
    {
     ...
     * @return object
     */
    protected function setPager(&$recPerPage = 20, &$pageID = 1)
    {
