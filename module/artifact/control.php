...
class artifact extends control
{
     ...
     * @return void
     */
    public function commonAction($spaceID = 0, $repoID = 0)
    {
     ...
     * @return void
     */
    public function browse($space = 0, $repoID = 0, $type = 'space', $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
     ...
     * @return void
     */
    public function view($artifactLibID, $spaceID = 0, $repoID = 0, $type = 'space', $selectPath = '', $leaf = 0, $orderBy = 'edited_desc', $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
     ...
     * @return void
     */
    public function create($space = 0, $repoID = 0, $type = 'space')
    {
     ...
     * @return void
     */
    public function createDir($artifactLibID, $path = '', $isSubDir = 0)
    {
        $artifactLib = $this->artifact->fetchByID($artifactLibID);
        $this->checkAccess($artifactLib->spaceID, $artifactLib->repoID);
     ...
     * @return void
     */
    public function editDir($artifactLibID, $path = '')
    {
        $artifactLib = $this->artifact->fetchByID($artifactLibID);
        $this->checkAccess($artifactLib->spaceID, $artifactLib->repoID);
     ...
     * @return void
     */
    public function editArtifact($assetID, $artifactLibID)
    {
        $artifactLib = $this->artifact->fetchByID($artifactLibID);
        $this->checkAccess($artifactLib->spaceID, $artifactLib->repoID);
     ...
     * @return void
     */
    public function downloadArtifact($assetID, $artifactLibID = 0)
    {
        $artifactLib = $this->artifact->fetchByID($artifactLibID);
        $this->checkAccess($artifactLib->spaceID, $artifactLib->repoID);
     ...
     * @return void
     */
    public function history($id, $artifactLibID)
    {
        $artifactLib = $this->artifact->fetchByID($artifactLibID);
        $this->checkAccess($artifactLib->spaceID, $artifactLib->repoID);
     ...
     * @return void
     */
    public function moveArtifact($assetID, $artifactLibID)
    {
        $artifactLib = $this->artifact->fetchByID($artifactLibID);
        $this->checkAccess($artifactLib->spaceID, $artifactLib->repoID);
     ...
     * @return void
     */
    public function ajaxGetDirParentItems($artifactLibID, $path = '')
    {
        $artifactLib = $this->artifact->fetchByID($artifactLibID);
        $path        = helper::safe64Decode($path);
     ...
     * @return void
     */
    public function ajaxGetFolders($artifactLibID, $path = '', $selectPath = '', $spaceID = 0, $repoID = 0, $type = 'space', $leaf = 0)
    {
        $artifactLib = $this->artifact->fetchByID($artifactLibID);
        $path        = helper::safe64Decode($path);
        $selectPath  = helper::safe64Decode($selectPath);
     ...
     * @return void
     */
    public function uploadArtifact($artifactLibID, $path = '')
    {
        $this->config->file->dangers = '';
        $artifactLib = $this->artifact->fetchByID($artifactLibID);
        $this->checkAccess($artifactLib->spaceID, $artifactLib->repoID);
     ...
     * @return void
     */
    public function deleteDir($artifactLibID, $entityID, $path = '')
    {
        $artifactLib = $this->artifact->fetchByID($artifactLibID);
        $this->checkAccess($artifactLib->spaceID, $artifactLib->repoID);
     ...
     * @return void
     */
    public function deleteArtifact($assetID, $artifactLibID = 0)
    {
        $artifactLib = $this->artifact->fetchByID($artifactLibID);
        $this->checkAccess($artifactLib->spaceID, $artifactLib->repoID);
     ...
     * @return void
     */
    public function ajaxBatchDeleteArtifact($artifactLibID)
    {
     ...
     * @return void
     */
    public function copyCMD($assetID)
    {
        $asset   = $this->loadModel('gitfox')->request('/artifacts/assets/' . $assetID);
