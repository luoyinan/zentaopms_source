...
class artifactZen extends artifact
{
     ...
     * @return array
     */
    public function getArtifactLibPickerItems($scope, $type, $spaces, $repos)
    {
     ...
     * @return array
     */
    public function getBreadCrumbs($artifactLib, $selectPathList, $spaceID = 0, $repoID = 0, $type = 'space')
    {
        $breadCrumbs = array();
     ...
     * @return array
     */
    public function getArtifactLibTreeData($artifactLib, $path = '/', $selectPath = '', $spaceID = 0, $repoID = 0, $type = 'space', $leaf = 0)
    {
        $items = array();
     ...
     * @return array
     */
    public function getParentPickerItems($artifactLib, $excludePath = '')
    {
     ...
     * @return array
     */
    protected function buildParentPickerChildren($artifactLib, $path = '/', $excludePath = '')
    {
        $items = array();
        $nodes = $this->artifact->getArtifactLibNodes($artifactLib, $path);
        if(empty($nodes)) return $items;
     ...
     * @return array
     */
    function buildTreeAction($item, $privs)
    {
        $actions = array();
     ...
     * @return object|array
     */
    public function getNodeByPath($artifactLib, $path)
    {
