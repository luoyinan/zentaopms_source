...
class artifactModel extends model
{
     ...
     * @return array
     */
    public function getLibList($spaceID = 0, $repoID = 0, $scope = 'space', $orderBy = 'id_desc', $pager = null)
    {
     ...
     * @return array
     */
    public function getLibPairs($scope = '', $type = '', $spaceIdList = array(), $repoIdList = array())
    {
     ...
     * @return array
     */
    public function getArtifactLibNodes($artifactLib, $path)
    {
        $nodes = array();
     ...
     */
    public function uploadArtifact($artifactLibID, $file, $path = '')
    {
     ...
     * @return array
     */
    public function getAssetListByNodeID($entityID, $artifactLibID = 0, $orderBy = 'editedDate_desc', $pager = null)
    {
     ...
     * @return bool
     */
    public function restoreEntity($action)
    {
     ...
     * @return bool
     */
    public function isClickable($artifact, $action)
    {
     ...
     * @return array
     */
    public function getLibsByProduct($productID)
    {
     ...
     * @return array
     */
    public function getAssetByIdList($assetIdList = array())
    {
     ...
     * @return string
     */
    public function parseArtifactSize($size)
    {
        if(!$size) return '';
     ...
     * @return array
     */
    public function getByRepoID($repoID)
    {
        return $this->dao->select('*')->from(TABLE_ARTIFACT)
            ->where('deleted')->eq(0)
     ...
     * @return array
     */
    public function getLibListByScope($scope, $type = '', $spaceIdList = array(), $repoIdList = array())
    {
        return $this->dao->select('*')->from(TABLE_ARTIFACT)
            ->where('deleted')->eq(0)
     ...
     * @return array
     */
    public function buildArtifactLibPickerItems($spaces, $repos, $artifactLibs)
    {
     ...
     * @return string
     */
    public function parseDirname($path)
    {
        $path = dirname($path);
