...
class testtask extends control
{
     ...
     * @return void
     */
    public function cases($testtaskID, $browseType = 'all', $param = 0, $orderBy = 'id_desc', $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
        /* 获取测试单信息。*/
        /* Get testtask info. */
        $testtask = $this->testtask->getByID($testtaskID);
     ...
     * @return void
     */
    public function report($productID, $testtaskID, $browseType, $branchID, $moduleID = 0, $chartType = 'pie')
    {
     ...
     * @return void
     */
    public function groupCase($testtaskID, $browseType = 'all')
    {
        /* 检查测试单是否存在。*/
     ...
     * @return void
     */
    public function edit($testtaskID)
    {
        if(!empty($_POST))
        {
     ...
     * @return void
     */
    public function start($testtaskID)
    {
        if(!empty($_POST))
        {
     ...
     * @return void
     */
    public function close($testtaskID)
    {
        if(!empty($_POST))
        {
     ...
     * @return void
     */
    public function block($testtaskID)
    {
        if(!empty($_POST))
        {
     ...
     * @return void
     */
    public function activate($testtaskID)
    {
        if(!empty($_POST))
        {
     ...
     * @return void
     */
    public function linkCase($testtaskID, $type = 'all', $param = 0, $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
        if(!empty($_POST))
        {
     ...
     * @return void
     */
    public function batchUnlinkCases($testtaskID)
    {
     ...
     * @return void
     */
    public function batchRun($productID, $orderBy = 'id_desc', $from = 'testcase', $testtaskID = 0, $confirm = '')
    {
     ...
     * @return void
     */
    public function batchAssign($testtaskID, $account = '')
    {
     ...
     * @return void
     */
    public function ajaxGetDropMenu($productID, $branch, $testtaskID, $module, $method, $objectType = '', $objectID = 0)
    {
