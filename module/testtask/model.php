...
class testtaskModel extends model
{
     ...
     * @return array
     */
    public function getDataOfTestTaskPerRunResult($taskID, $caseQuery, $moduleID = 0)
    {
     ...
     * @return array
     */
    public function getDataOfTestTaskPerType($taskID, $caseQuery, $moduleID = 0)
    {
     ...
     * @return array
     */
    public function getDataOfTestTaskPerModule($taskID, $caseQuery, $moduleID = 0)
    {
     ...
     * @return array
     */
    public function getDataOfTestTaskPerRunner($taskID, $caseQuery, $moduleID = 0)
    {
