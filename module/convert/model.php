...
class convertModel extends model
{
     ...
     * @return array
     */
    public function getJiraData($method, $module, $lastID = '', $limit = '')
    {
        if($method == 'db')
        {
            $originDBH = $this->dbh;
...
EOT;
     ...
     * @return array
     */
    public function importJiraData($type = '', $lastID = 0, $createTable = 0, $getApiData = 0)
    {
     ...
     * @return array
     */
    public function getJiraStatusList($step = '', $getDataMethod = '')
    {
     ...
     * @return array
     */
    public function getJiraCustomField($getDataMethod = '')
    {
     ...
     * @return array
     */
    public function getJiraWorkflowActions($getDataMethod = '')
    {
        if($this->config->edition == 'open') return array();
        if(empty($getDataMethod)) $getDataMethod = $this->session->jiraMethod;
     ...
     * @return array
     */
    public function getJiraDataToJson($module, $lastID = 0, $limit = 0)
    {
     ...
     * @return array
     */
    public function getJiraDataFromJson($module, $lastID = '', $limit = '', $getAll = false)
    {
        $filePath = $this->app->getTmpRoot() . 'jirafile/json/';
