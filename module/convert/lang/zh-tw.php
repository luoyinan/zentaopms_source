...
$lang->convert->importFailed       = '導入失敗，請刷新頁面重新嘗試。';
...
$lang->convert->jira->getDataResult      = "正在獲取Jira <strong class='text-danger'>%s</strong> 數據, 已獲取 <strong class='%scount'>%s</strong> 條記錄；";
$lang->convert->jira->getDataSuccess     = '獲取Jira數據完成，開始導入jira數據。';
...
$lang->convert->jira->noCustomeFields    = '此對象沒有需要配置的欄位，請點擊下一步。';
