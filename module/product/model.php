...
class productModel extends model
{
     ...
     * @return array
     */
    public function getProjectListByProduct($productID, $browseType = 'all', $branch = '0', $involved = false, $orderBy = '`order`_desc', $pager = null)
    {
     ...
     * @return int[]
     */
    public function getProjectStatsByProduct($productID, $browseType = 'all', $branch = '0', $involved = false, $orderBy = '`order`_desc', $pager = null)
    {
     ...
     * @return array
     */
    public function getStats($productIdList, $orderBy = '`order`_asc', $pager = null, $storyType = 'story', $programID = 0)
    {
