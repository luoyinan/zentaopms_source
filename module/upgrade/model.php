...
class upgradeModel extends model
{
     ...
     * @return string
     */
    public function getDeleteScriptPath()
    {
     ...
     * @return bool
     */
    public function computeDefaultSchedule()
    {
        $this->loadModel('project');
     ...
     * @return bool
     */
    public function updateReviewedByField()
    {
        if($this->config->edition == 'open') return true;
     ...
     * @return bool
     */
    public function addUserGroup($checkedPrivs, $addPrivs)
    {
     ...
     * @return bool
     */
    public function addDefaultWorkflowAction($code)
    {
     ...
     * @return bool
     */
    protected function migrateDevopsGroupPrivs()
    {
