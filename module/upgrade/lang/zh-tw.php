...
$lang->upgrade->upgradeFeatureDesc = '22.4版本，整合 DevOps 4.0 強大功能';

$lang->upgrade->upgradeFeatures = array();
$lang->upgrade->upgradeFeatures[1][] = array('icon' => 'rocket',    'title' => '全面升級', 'desc' => '自研GitFox引擎，打通CI/CD流程，實現代碼的全生命周期管理。');
$lang->upgrade->upgradeFeatures[1][] = array('icon' => 'code-fork', 'title' => '分支類型', 'desc' => '支持自定義分支類型，按分支類型設定規則，管理更規範。');
$lang->upgrade->upgradeFeatures[1][] = array('icon' => 'bell',      'title' => 'WebHook',  'desc' => '代碼庫級別的 Webhook 配置，輕鬆對接外部系統，通知更實時。');
$lang->upgrade->upgradeFeatures[1][] = array('icon' => 'checkbox',  'title' => '代碼掃瞄', 'desc' => '內置 2000+ 掃瞄規則，自動檢查規範與隱患，嚴把代碼質量。');
$lang->upgrade->upgradeFeatures[2][] = array('icon' => 'code',      'title' => '代碼管理', 'desc' => '完整支持Git代碼庫管理，支持SVN代碼庫查看。');
$lang->upgrade->upgradeFeatures[2][] = array('icon' => 'review',    'title' => '代碼評審', 'desc' => '每次推送或合併請求均可發起評審，逐筆把關代碼質量。');
$lang->upgrade->upgradeFeatures[2][] = array('icon' => 'flow',      'title' => '流水綫',   'desc' => '支持導入主流流水綫（如 Jenkins），可配置多種觸發方式。');
$lang->upgrade->upgradeFeatures[2][] = array('icon' => 'stack',     'title' => '製品庫',   'desc' => '多層級、多類型的製品管理，打通 CI/CD流程，流轉安全高效。');
