...
class repo extends control
{
     ...
     * @return void
     */
    public function commonAction($repoID = 0, $objectID = 0, $spaceID = 0)
    {
     ...
     * @return void
     */
    public function maintain($inSpace = 0, $space = 0, $objectID = 0, $orderBy = 'id_desc', $recPerPage = 20, $pageID = 1, $type = '', $param = 0)
    {
        $serverHeath = $this->loadModel('gitfox')->checkHealth();
        if(!$serverHeath) return $this->locate($this->createLink('gitfox', "installGitFox"));
     ...
     * @return void
     */
    public function create($objectID = 0, $spaceID = 0)
    {
        if($_POST)
        {
            /* Prepare data. */
     ...
     * @return void
     */
    public function createRepo($objectID = 0, $spaceID = 0)
    {
        if($_POST)
        {
     ...
     * @return void
     */
    public function edit($repoID, $objectID = 0, $spaceID = 0)
    {
     ...
     * @return void
     */
    public function import($spaceID = 0, $type = 'GitLab', $providerID = 0, $groupID = '', $isTryAgain = 0)
    {
     ...
     * @return void
     */
    public function ajaxGetDiffEditorContent($repoID, $objectID = 0, $entry = '', $oldRevision = '', $newRevision = '', $showBug = 0, $encoding = '', $showLinkObject = 1)
    {
     ...
     * @return void
     */
    public function ajaxGetEditorContent($repoID, $objectID = 0, $entry = '', $revision = 'HEAD', $showBug = 0, $encoding = '', $showLinkObject = 1)
    {
        $this->app->loadConfig('misc');
        if(!$entry) $entry = (string) $this->cookie->repoCodePath;
     ...
     * @return void
     */
    public function ajaxMirrorSync($repoID = 0)
    {
        $repo = $this->repo->getByID($repoID);
     ...
     * @return void
     */
    public function ajaxMirrorSyncProgress($repoID = 0)
    {
        $repo = $this->repo->getByID($repoID);
        if(empty($repo)) return $this->send(array('result' => 'fail', 'message' => $this->lang->repo->error->noFound));
     ...
     * @return string
     */
    protected function decodeEditorRevision($revision)
    {
     ...
     * @return void
     */
    public function ajaxGetFiles($repoID, $branch = '', $path = '', $selectFile = '')
    {
        $repo = $this->repo->getByID($repoID);
     ...
     * @return void
     */
    public function browseWebhooks($repoID, $orderBy = 'createdDate_desc', $recPerPage = 20, $pageID = 1)
    {
     ...
     * @return void
     */
    public function createWebhook($repoID)
    {
        $repoID = $this->repoZen->processRepoID($repoID, 0);
        $this->commonAction($repoID, 0);
     ...
     * @return void
     */
    public function editWebhook($repoID, $webhookID)
    {
        $repoID = $this->repoZen->processRepoID($repoID, 0);
        $this->commonAction($repoID, 0);
     ...
     * @return void
     */
    public function logWebhook($repoID, $webhookID, $orderBy = 'created_desc', $recPerPage = 20, $pageID = 1)
    {
        $repoID = $this->repoZen->processRepoID($repoID, 0);
        $this->commonAction($repoID, 0);
     ...
     * @return void
     */
    public function enableWebhook($repoID, $webhookID, $isEnable)
    {
        $repo = $this->repo->getByID($repoID);
     ...
     * @return void
     */
    public function deleteWebhook($repoID, $webhookID)
    {
        $repo = $this->repo->getByID($repoID);
        $logs = $this->loadModel('gitfox')->apiGetWebhookExecution((int)$repo->id, $webhookID);
     ...
     * @return void
     */
    public function viewWebhookRequest($repoID, $webhookID, $executionID)
    {
        $repo    = $this->repo->getByID($repoID);
     ...
     * @return void
     */
    public function browseBranch($repoID, $objectID = 0, $label = 'all', $showArchived = 'active', $keyword = '', $orderBy = 'date_desc', $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
        $repoID = $this->repoZen->processRepoID($repoID, $objectID);
        $this->commonAction($repoID, $objectID);
     ...
     * @return void
     */
    public function ajaxGetSpaceMembers($spaceID)
    {
     ...
     * @return void
     */
    public function browseSystem($space = 0, $type = 'all',$orderBy = 'id_desc', $recTotal = 0, $recPerPage = 20, $pageID = 1, $param = 0)
    {
        $this->app->loadClass('pager', true);
     ...
     * @return void
     */
    public function createRepoBranch($objectID, $repoID)
    {
        $repoPairs = array();
        if($objectID != 0)
        {
     ...
     * @return void
     */
    public function createTag($objectID, $repoID = 0)
    {
     ...
     * @return void
     */
    public function deleteBranch($repoID, $branch)
    {
     ...
     * @return void
     */
    public function deleteTag($repoID, $tag)
    {
     ...
     * @return object
     */
    public function ajaxGetBranchCommits($repoID, $branchID, $search = '')
    {
        $repo = $this->repo->getByID($repoID);
     ...
     * @return void
     */
    public function ajaxShowImportProgress($repoID, $spaceID = 0)
    {
     ...
     * @return void
     */
    public function ajaxGetImportProgress($repoID)
    {
     ...
     * @return void
     */
    public function ajaxShowImportResult($repoID, $spaceID = 0)
    {
        $result = $this->loadModel('gitfox')->request("/repos/import-progress", 'GET', array('repoID' => $repoID));
