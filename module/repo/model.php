...
class repoModel extends model
{
     ...
     * @return void
     */
    public function setMenu($repos, $repoID = 0, $spaceID = 0)
    {
     ...
     * @return array
     */
    public function getList($projectID = 0, $space = 0, $orderBy = 'id_desc', $pager = null, $getCodePath = false, $lastSubmitTime = false, $type = '', $param = 0)
    {
     ...
     * @return array
     */
    public function getListByPriv($type = 'all', $scmType = '', $useSCM = true)
    {
     ...
     * @return bool
     */
    public function update($data, $repo)
    {
     ...
     * @return array
     */
    public function getRepoPairs($type = '', $projectID = 0, $showScm = false)
    {
     ...
     * @return string
     */
    public function parseRepoPath($path)
    {
     ...
     * @return string
     */
    public function createLink($method, $params = '', $viewType = 'html')
    {
     ...
     * @return bool
     */
    protected function isRecordedWebhookCommit($commit)
    {
        $revision = '';
     ...
     * @return void
     */
    public function loadMaintainSpacePrivs($repoList)
    {
     ...
     * @return array
     */
    public function getProviderRepos($provider, $showPairs = false)
    {
     ...
     * @return array
     */
    public function getListByCondition($repoQuery, $space = 0, $orderBy = 'id_desc', $pager = null)
    {
        $userSpaces = $this->loadModel('space')->getPairs($this->app->user->account);
     ...
     * @return array
     */
    public function getListByProduct($productID, $limit = 0)
    {
        return $this->dao->select('*')->from(TABLE_REPO)
            ->where('deleted')->eq('0')
            ->andWhere('status')->ne('importing')
     ...
     * @return array
     */
    public function getRepoUsers($repoID)
    {
     ...
     * @return array
     */
    public function getRepoMembers($repo)
    {
     ...
     * @return bool
     */
    public function updateMembers($repoID, $members)
    {
     ...
     * @return array
     */
    public function getListBySpaces($spaceIdList)
    {
     ...
     * @return array
     */
    public function getSystemList($systemQuery = '', $space = 0)
    {
     ...
     * @return array
     */
    public function getGitFoxRepos()
    {
        return $this->dao->select('*')->from(TABLE_REPO)
            ->where('deleted')->eq(0)
            ->andWhere('status')->ne('importing')
     ...
     * @return void
     */
    public function buildSystemSearchForm($queryID, $actionURL, $cacheSearchFunc = true)
    {
     ...
     * @return array
     */
    public function getGitLabRepos($apiRoot)
    {
     ...
     * @return array
     */
    public function getGiteaRepos($apiRoot)
    {
        if(empty($apiRoot)) return array();
     ...
     * @return array
     */
    public function getGogsRepos($apiRoot)
    {
        if(empty($apiRoot)) return array();
     ...
     * @return object|false
     */
    public function getProviderRepo($provider, $repoID)
    {
     ...
     * @return bool
     */
    public function migrateRepoData()
    {
     ...
     * @return array
     */
    private function parseRepoAcl($oldRepo)
    {
        $repoAcl = 'open';
        $members = array();
     ...
     * @return object
     */
    private function buildNewRepo($oldRepo, $repoAcl, $admins)
    {
        $repo          = new stdClass();
     ...
     * @return array
     */
    private function extractPathSlug($path)
    {
        $path  = trim($path);
     ...
     * @return bool
     */
    private function insertMembers($repoID, $members)
    {
        $values = array();
     ...
     * @return string
     */
    public function convertChineseToPinyin($string)
    {
