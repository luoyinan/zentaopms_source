...
class repoZen extends repo
{
     ...
     * @return void
     */
    protected function setBrowseSession($repo = null)
    {
     ...
     * @return void
     */
    protected function buildRepoSearchForm($inSpace, $space, $products, $objectID, $orderBy, $recPerPage, $pageID, $param)
    {
     ...
     * @return array
     */
    protected function getSyncBranches(&$branchID = '')
    {
        $branches = array();
     ...
     * @return array
     */
    protected function getViewTree($repo, $entry, $revision, $selectFile = '')
    {
        $scm = $this->app->loadClass('scm');
        $scm->setEngine($repo);
     ...
     * @return object
     */
    public function buildWebhook($webhookFormData, $repo, $editWebhook = null)
    {
     ...
     * @return string
     */
    public function getSystemSearchQuery($queryID)
    {
     ...
     * @return void
     */
    public function buildImportForm($providerID, $groupID, $type)
    {
     ...
     * @return array
     */
    public function setImportFormConfig($type, $providerID = 0, $acl = 'open')
    {
        if($type == 'Subversion')
        {
