...
$lang->my->devopsLink      = 'DevOps視圖着陸頁';
$lang->my->devopsspaceLink = 'DevOps空間着陸頁';
...
$lang->my->devopsspaceLinkList['repo-maintain'] = '空間下的代碼庫列表';
$lang->my->devopsspaceLinkList['repo-browse']   = '最近一個瀏覽的代碼庫';

$lang->my->devopsLinkList = array();
$lang->my->devopsLinkList['space-browse']  = '空間列表';
$lang->my->devopsLinkList['repo-maintain'] = '代碼庫列表';
$lang->my->devopsLinkList['repo-browse']   = '最近一個瀏覽的代碼庫';
...
$lang->my->featureBar['audit']['ppm']         = '評審請求';
...
$lang->my->featureBar['work']['testtask']['assignedTo'] = '我參與的';
...
$lang->my->ssh              = '瀏覽SSH密鑰';
$lang->my->createSSH        = '新增SSH密鑰';
$lang->my->editSSH          = '編輯SSH密鑰';
$lang->my->deleteSSH        = '刪除SSH密鑰';
$lang->my->publicKey        = '公鑰';
$lang->my->createdDate      = '創建時間';
$lang->my->lastUsed         = '最後使用';
$lang->my->confirmDeleteSSH = '確定要刪除該SSH密鑰嗎?';
$lang->my->sshKeyTip        = "公鑰必須以'ssh-rsa'、'ecdsa-sha2-nistp256'、'ecdsa-sha2-nistp384'、'ecdsa-sha2-nistp521'、'ssh-ed25519'、'sk-ecdsa-sha2-nistp256@openssh.com' 或 'sk-ssh-ed25519@openssh.com'開頭。";
$lang->my->nameFormat       = "請輸入有效的名稱，只能包含字母、數字、'-'、'_'、'.' 和 '$'。";
