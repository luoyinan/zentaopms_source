...
class repobranchtype extends control
{
     ...
     * @return void
     */
    public function browse($repoID = 0, $orderBy = 'id_asc', $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
        /* 设置菜单。 */
        if($repoID)
        {
     ...
     * @return void
     */
    public function edit($repoID = 0, $typeID = 0)
    {
        /* 设置菜单。 */
     ...
     * @return void
     */
    public function delete($repoID = 0, $typeID = 0)
    {
        /* 设置菜单。 */
        if($repoID) $this->loadModel('ci')->setMenu($repoID);
     ...
     * @return void
     */
    public function import($repoID = 0, $orderBy = 'id_asc', $recTotal = 0, $recPerPage = 100, $pageID = 1)
    {
        /* 设置菜单。 */
        if($repoID) $this->loadModel('ci')->setMenu($repoID);
