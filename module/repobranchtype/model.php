...
class repobranchtypeModel extends model
{
     ...
     * @return bool
     */
    public function apiCreateBranchType($repoID, $formData)
    {
        /* 确保 prefixes 是数组。 */
     ...
     * @return bool
     */
    public function apiDeleteBranchType($repo, $typeID)
    {
     ...
     * @return bool
     */
    public function apiUpdateBranchType($repo, $typeID, $formData)
    {
        /* 确保 prefixes 是数组。 */
        $prefixes = $formData->prefixes;
        if(is_string($prefixes)) $prefixes = explode(',', $prefixes);
     ...
     * @return bool
     */
    public function importBranchTypes($repo, $branchTypeIDs)
    {
     ...
     * @return array
     */
    public function getBranchTypePairs($repoID = 0)
    {
     ...
     * @return array
     */
    public function getBranchTypeList($repoID = 0, $name = '', $key = '', $prefix = '', $orderBy = 'id_desc', $pager = null)
    {
     ...
     * @return object|null
     */
    public function getBranchTypeByID($typeID)
    {
     ...
     * @return array
     */
    public function getBranchTypeByIDs($typeIDs)
    {
     ...
     * @return array
     */
    public function getBranchTypeByRepoID($repoID, $orderBy = 'id_desc')
    {
        $branchTypes = $this->dao->select('*')->from(TABLE_BRANCHTYPE)
     ...
     * @return array
     */
    protected function parsePrefixToArray($prefix)
    {
     ...
     * @return array
     */
    public function getByBranches($repoID, $branchList)
    {
