...
class requirement extends control
{
     ...
     * @return void
     */
    public function copy($productID = 0, $branch = '', $moduleID = 0, $storyID = 0, $objectID = 0, $bugID = 0, $planID = 0, $todoID = 0, $extra = '')
    {
        echo $this->fetch('story', 'create', "productID=$productID&branch=$branch&moduleID=$moduleID&storyID=$storyID&objectID=$objectID&bugID=$bugID&planID=$planID&todoID=$todoID&extra=$extra&storyType=requirement");
    }
     ...
     * @return void
     */
    public function edit($requirementID, $kanbanGroup = 'default')
    {
     ...
     * @return void
     */
    public function linkStory($storyID, $type = 'linkStories', $linkedStoryID = 0, $browseType = '', $queryID = 0, $recTotal = 0, $recPerPage = 20, $pageID = 1, $orderBy = 'id_desc')
    {
