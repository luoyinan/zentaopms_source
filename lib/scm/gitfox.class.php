...
class gitfoxRepo
{
     ...
     * @return array
     */
    public function tags($showDetail = '', $revision = 'HEAD', $onlyDir = true, $orderBy = '', $limit = 0, $pageID = 0)
    {
        $api  = 'tags/list';
        $tags = array();
     ...
     * @return array
     */
    public function branch($showDetail = '', $orderBy = '', $limit = 0, $pageID = 1, $label = '', $showArchived = 'active')
    {
        $params = array();
     ...
     *  @return object|null
     */
    public function createMR($MR, $openID)
    {
     ...
     * @return array|object
     */
    public function getCodeFrequencyByRepo($repoID, $period, $begin = '', $end = '')
    {
     ...
     * @return array|object
     */
    public function getCodeFrequencyByUser($account, $period, $begin = '', $end = '')
    {
        if(!$begin) $begin = date('Y-m-d', strtotime('-1 year'));
        if(!$end)   $end   = date('Y-m-d');
     ...
     * @return array
     */
    public function getBranchesCommitsDivergence($branches, $defaultBranch = '')
    {
        $params = array();
     ...
     * @return array|object
     */
    public function countActiveRepos($repos, $begin = '', $end = '')
    {
        if(!$begin) $begin = date('Y-m-d', strtotime('-1 year'));
        if(!$end)   $end   = date('Y-m-d');
