...
class userSelector extends wg
{
     ...
     */
    protected function normalizeExistingUsers()
    {
     ...
     */
    protected function normalizeDepts()
    {
        $deptList = array();
     ...
     * @return array
     */
    protected function normalizeUsers($deptMap, $selected, $existingUsers = array())
    {
        $userList = array();
     ...
     */
    protected function buildDeptTree($deptMap, $parent = 0)
    {
     ...
     */
    protected function buildUserList($users)
    {
     ...
     */
    protected function buildSelectedList($users, $selected)
    {
     ...
     * provided field name.
     */
    protected function buildHiddenInputs($selected)
    {
        $name      = $this->prop('name');
