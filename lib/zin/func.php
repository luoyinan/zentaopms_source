...
function versiondiff() {return createWg('versiondiff', func_get_args());}
...
function userSelector() {return createWg('userSelector', func_get_args());}
...
function workflowfield() {return createWg('workflowfield', func_get_args());}
function formula() {return createWg('formula', func_get_args());}
function workflowCondition() {return createWg('workflowCondition', func_get_args());}
function workflowFieldCondition() {return createWg('workflowFieldCondition', func_get_args());}
function markdown() {return createWg('markdown', func_get_args());}
